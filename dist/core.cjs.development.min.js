...
const K = { Raydium: { Openbook: !0 } }, U = { Symmetry: !0, Openbook: !0, Cykura: !0, Meteora: { Lifinity: !0, "Lifinity V2": !0, Balansol: !0, Crema: !0, Dradex: !0, Raydium: !0, BonkSwap: !0, Oasis: !0 }, Crema: { Balansol: !0, Raydium: !0, Lifinity: !0, "Lifinity V2": !0 }, BonkSwap: { Lifinity: !0, "Lifinity V2": !0, Balansol: !0, Crema: !0, Dradex: !0, Raydium: !0, Oasis: !0 }, Oasis: { Lifinity: !0, "Lifinity V2": !0, Balansol: !0, Crema: !0, Dradex: !0, Raydium: !0, BonkSwap: !0 }, Dradex: { Lifinity: !0, "Lifinity V2": !0, Balansol: !0, Crema: !0, Raydium: !0 }, Balansol: { Raydium: !0 }, Lifinity: { Raydium: !0 }, "Lifinity V2": { Raydium: !0 } }, V = { Symmetry: !0, Raydium: !0, GooseFX: !0, Meteora: !0, Serum: !0, Openbook: !0, Dradex: !0, Crema: !0, Lifinity: !0, "Lifinity V2": !0 }, G = (e, t, n) => { const o = e[t];

if (o) { if (!0 === o || !0 === o["*"]) return !0;

if (n) return !0 === o[n] } return !1 }, Y = (e, t, n) => G(e, t, n) || !!n && G(e, n, t);

function W(e, t) { return Array.apply(0, new Array(Math.ceil(e.length / t))).map(((n, o) => e.slice(o * t, (o + 1) * t))) } async function z(t, n, o = 1e3, i = 100) { return (await Promise.all(W(n, o).map((async n => { const o = W(n, i).map((e => ({ methodName: "getMultipleAccounts", args: t._buildArgs([e], t.commitment, "base64+zstd") })));

return t._rpcBatchRequest(o).then((t => t.reduce(((t, n) => (n.result.value.forEach((n => { if (n) { const o = n;

o.data = Buffer.from(q.decompress(Buffer.from(n.data[0], "base64"))), o.owner = new e.PublicKey(n.owner), t.push(o) } else t.push(null) })), t)), []))).catch((e => n.map((() => null)))) })))).flat() } var X;

exports.SwapMode = void 0, (X = exports.SwapMode || (exports.SwapMode = {})).ExactIn = "ExactIn", X.ExactOut = "ExactOut";

const j = (e, t) => t.map((t => { const n = e.get(t.toString());

if (!n) throw new Error(`Account info ${t.toBase58()} missing`);

return n })), Q = e => e.map((e => { const t = r.deserializeAccount(e.data);

if (!t) throw new Error("Invalid token account");

return t })).map((e => _.default.BigInt(e.amount))), J = "Missing tokenReserveAmounts", $ = async (e, t) => { const n = e.map((e => e.getAccountsForUpdate().map((e => e.toBase58())))).flat(), o = new Map;
...
const te = e => new ee(8, e), ne = e => new ee(16, e), oe = e => Buffer.isBuffer(e) ? e : e instanceof Uint8Array ? Buffer.from(e.buffer, e.byteOffset, e.byteLength) : Buffer.from(e);
...
se = d.struct(
    [d.u8("isInitialized"), H("stateOwner"), H("feeOwner"), te("initialSupply"), te("returnFeeNumerator"), te("fixedFeeNumerator"), te("feeDenominator"), d.u8("curveType"), d.blob(32, "curveParameters")]
), 
...
return 2 * t.toNumber() } getAccountsForUpdate() { return [this.poolState.quoteTokenVault, this.poolState.baseTokenVault] } update(e) { const t = j(e, this.getAccountsForUpdate());

this.tokenReserveAmounts = Q(t) } getQuote({ sourceMint: e, amount: t }) { if (!this.tokenReserveAmounts) throw new Error(J);

let n = new C.default(this.poolState.fees.traderFee.numerator.toString()).div(this.poolState.fees.traderFee.denominator.toString()).add(new C.default(this.poolState.fees.ownerFee.numerator.toString()).div(this.poolState.fees.ownerFee.denominator.toString()));

const o = this.poolState.baseTokenMint.equals(e) ? 0 : 1;

let i = this.calculator.exchange(this.tokenReserveAmounts, t, o);

return { notEnoughLiquidity: !1, inAmount: t, outAmount: i.expectedOutputAmount, feeAmount: i.fees, feeMint: e.toBase58(), feePct: n.toNumber(), priceImpactPct: i.priceImpact.toNumber() } } getSwapLegAndAccounts(e) { if (this.poolState.isV2) { if (!this.poolState.curve) throw new Error("Unable to fetch curve account.");

return function ({ poolState: e, sourceMint: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, curve: i, userTransferAuthority: a }) { const [s, r, c] = t.equals(e.baseTokenMint) ? [ce.Ask, n, o] : [ce.Bid, o, n];

return [Pe(pe(s)), m.JUPITER_PROGRAM.instruction.aldrinV2Swap({ accounts: { swapProgram: m.ALDRIN_SWAP_V2_PROGRAM_ID, pool: e.address, poolSigner: e.poolSigner, poolMint: e.poolMint, baseTokenVault: e.baseTokenVault, quoteTokenVault: e.quoteTokenVault, feePoolTokenAccount: e.feePoolTokenAccount, walletAuthority: a, userBaseTokenAccount: r, userQuoteTokenAccount: c, curve: i, tokenProgram: u.TOKEN_PROGRAM_ID } }).keys] }({ poolState: this.poolState, curve: this.poolState.curve, ...e }) } return function ({ poolState: e, sourceMint: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: i }) { const [a, s, r] = t.equals(e.baseTokenMint) ? [ce.Ask, n, o] : [ce.Bid, o, n];

return [Pe(le(a)), m.JUPITER_PROGRAM.instruction.aldrinSwap({ accounts: { swapProgram: m.ALDRIN_SWAP_PROGRAM_ID, pool: e.address, poolSigner: e.poolSigner, poolMint: e.poolMint, baseTokenVault: e.baseTokenVault, quoteTokenVault: e.quoteTokenVault, feePoolTokenAccount: e.feePoolTokenAccount, walletAuthority: i, userBaseTokenAccount: s, userQuoteTokenAccount: r, tokenProgram: u.TOKEN_PROGRAM_ID } }).keys] }({ poolState: this.poolState, ...e }) } get reserveTokenMints() { return [this.poolState.quoteTokenMint, this.poolState.baseTokenMint] } } je.accountInfoToAldrinPoolState = Xe;

const Qe = { version: "0.1.0", name: "balancer_amm", instructions: [{ name: "swap", accounts: [{ name: "authority", isMut: !0, isSigner: !0 }, { name: "pool", isMut: !0, isSigner: !1 }, { name: "taxMan", isMut: !0, isSigner: !1 }, { name: "bidMint", isMut: !1, isSigner: !1 }, { name: "treasurer", isMut: !1, isSigner: !1 }, { name: "srcTreasury", isMut: !0, isSigner: !1 }, { name: "srcAssociatedTokenAccount", isMut: !0, isSigner: !1 }, { name: "askMint", isMut: !1, isSigner: !1 }, { name: "dstTreasury", isMut: !0, isSigner: !1 }, { name: "dstAssociatedTokenAccount", isMut: !0, isSigner: !1 }, { name: "dstTokenAccountTaxman", isMut: !0, isSigner: !1 }, { name: "systemProgram", isMut: !1, isSigner: !1 }, { name: "tokenProgram", isMut: !1, isSigner: !1 }, { name: "associatedTokenProgram", isMut: !1, isSigner: !1 }, { name: "rent", isMut: !1, isSigner: !1 }], args: [{ name: "bidAmount", type: "u64" }, { name: "limit", type: "u64" }], returns: "u64" }], accounts: [{ name: "pool", type: { kind: "struct", fields: [{ name: "authority", type: "publicKey" }, { name: "fee", type: "u64" }, { name: "taxFee", type: "u64" }, { name: "state", type: { defined: "PoolState" } }, { name: "mintLpt", type: "publicKey" }, { name: "taxMan", type: "publicKey" }, { name: "mints", type: { vec: "publicKey" } }, { name: "actions", type: { vec: { defined: "MintActionState" } } }, { name: "treasuries", type: { vec: "publicKey" } }, { name: "reserves", type: { vec: "u64" } }, { name: "weights", type: { vec: "u64" } }] } }], types: [{ name: "PoolState", type: { kind: "enum", variants: [{ name: "Uninitialized" }, { name: "Initialized" }, { name: "Frozen" }, { name: "Deleted" }] } }, { name: "MintActionState", type: { kind: "enum", variants: [{ name: "Active" }, { name: "BidOnly" }, { name: "AskOnly" }, { name: "Paused" }] } }], errors: [] }, Je = 10 ** 9, $e = (e, t) => { const n = e.map((e => e.toNumber() / Je));

return t.toNumber() / Je / n.reduce(((e, t) => e + t), 0) }, Ze = (e, t) => { const { balanceIn: n, balanceOut: o, weightIn: i, weightOut: a, swapFee: s } = t, r = Number(n.toString()), u = Number(o.toString()), c = i, m = a, d = Number(s.toString()) / Je;

return -r * m / (u * (-1 + d) * (r / (e + r - e * d)) ** ((c + m) / m) * c) }, He = new p.BorshAccountsCoder(Qe);

class et { constructor(e, t) { this.address = void 0, this.label = "Balansol", this.id = void 0, this.shouldPrefetch = !0, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.poolData = void 0, this.address = e, this.id = e.toBase58(), this.poolData = He.decode("pool", t.data) } getAccountsForUpdate() { return [new e.PublicKey(this.id)] } update(e) { let [t] = j(e, this.getAccountsForUpdate());

const n = He.decode("pool", t.data);

this.poolData = n } getQuote({ sourceMint: e, destinationMint: t, amount: n }) { var o, i;
...
const a = this.poolData.mints.map((e => e.toBase58())), s = a.indexOf(e.toBase58()), r = a.indexOf(t.toBase58());
...
const u = $e(this.poolData.weights, this.poolData.weights[s]), c = $e(this.poolData.weights, this.poolData.weights[r]), m = ((e, t, n, o, i, a) => { const s = Number(t.toString()), r = Number(n.toString());

return s * (1 - (r / (r + e)) ** (i / o)) * (1 - Number(a.toString()) / Je) })(Number(n.toString()), this.poolData.reserves[r], this.poolData.reserves[s], c, u, this.poolData.fee.add(this.poolData.taxFee)), d = ((e, t) => { const n = Ze(0, t), o = Ze(e, t);

return o < n ? 0 : 1 - n / o })(Number(n.toString()), { balanceIn: this.poolData.reserves[s], balanceOut: this.poolData.reserves[r], weightIn: u, weightOut: c, swapFee: this.poolData.fee.add(this.poolData.taxFee) }), l = this.poolData.fee.add(this.poolData.taxFee).toNumber() / 10 ** 9, p = m / (1 - l) * l;

return { notEnoughLiquidity: !1, inAmount: n, outAmount: _.default.BigInt(Math.floor(m)), feeAmount: _.default.BigInt(Math.floor(p)), feeMint: t.toBase58(), feePct: 0, priceImpactPct: d } } getSwapLegAndAccounts(t) { var n;

if (!this.poolData) throw new Error(`Invalid pool data ${this.address.toBase58()}`);

const o = this.poolData.mints.findIndex((e => e.equals(t.sourceMint))), i = this.poolData.mints.findIndex((e => e.equals(t.destinationMint))), [a] = e.PublicKey.findProgramAddressSync([Buffer.from("treasurer"), this.address.toBuffer()], m.BALANSOL_PROGRAM_ID), s = m.findAssociatedTokenAddress({ tokenMintAddress: t.destinationMint, walletAddress: this.poolData.taxMan });
...
class nt { constructor(e, t, n) { this.address = void 0, this.id = void 0, this.label = "Crema", this.shouldPrefetch = !0, this.exactOutputSupported = !1, this.hasDynamicAccounts = !0, this.clmmpoolData = void 0, this.reserveTokenDecimals = void 0, this.tickArrayMapPubkey = void 0, this.feeRate = void 0, this.tickArrayMap = void 0, this.tickArrayPubkeys = [], this.tickArrays = [], this.arrayStartIndex = void 0, this.swapTicks = void 0, this.address = e, this.id = e.toBase58(), this.clmmpoolData = tt.accounts.decode("clmmpool", t.data), this.feeRate = this.clmmpoolData.feeRate, this.tickArrayMapPubkey = g.PDAUtil.getTickArrayMapPDA(m.CREMA_PROGRAM_ID, e).publicKey, this.reserveTokenDecimals = [n.decimalA, n.decimalB], this.arrayStartIndex = 0 } getAccountsForUpdate() { return [this.address, this.tickArrayMapPubkey, ...this.tickArrayPubkeys] } update(e) { const t = e.get(this.address.toBase58());

if (!t) throw new Error(`Missing poolData ${this.address.toBase58()}`);

this.clmmpoolData = tt.accounts.decode("clmmpool", t.data), this.feeRate = this.clmmpoolData.feeRate;
...
const i = g.TickUtil.getArrayIndex(this.clmmpoolData.currentTickIndex, this.clmmpoolData.tickSpacing);
...
t < this.tickArrayPubkeys.length;

t++) { const n = e.get(this.tickArrayPubkeys[t].toBase58());

if (n) { const e = tt.accounts.decode("tickArray", n.data);

!1 === a && e.arrayIndex >= i && (a = !0, this.arrayStartIndex = t), s.push({ address: this.tickArrayPubkeys[t], data: e }) } } this.tickArrays = s;

const r = { aToB: [], bToA: [] };

for (let e = this.arrayStartIndex;

e > this.arrayStartIndex - 3;

e--) { let t = this.tickArrays[e];

t && r.aToB.push(t) } for (let e = this.arrayStartIndex;

e < this.arrayStartIndex + 3;

e++) { let t = this.tickArrays[e];

t && r.bToA.push(t) } this.swapTicks = { aToB: [], bToA: [] }, [r.aToB, r.bToA].forEach(((e, t) => { for (let n = 0;

n < e.length;

n++) { const o = e[n];

if (0 === t) for (let e = g.TICK_ARRAY_SIZE - 1;

e >= 0;

e--)o.data && o.data.ticks[e].isInitialized && this.swapTicks.aToB.push(o.data.ticks[e]);

else for (let e = 0;

e < g.TICK_ARRAY_SIZE;

e++)o.data && o.data.ticks[e].isInitialized && this.swapTicks.bToA.push(o.data.ticks[e]) } })) } getTickArrayPubkeys(e, t) { let n = [];
...
e++)n.push((o >> e & 1) > 0) } const o = [];

for (let t = 0;

t < n.length;

t++)if (n[t]) { const n = g.PDAUtil.getTickArrayPDA(m.CREMA_PROGRAM_ID, e, t).publicKey;

o.push(n) } return o } getQuote(e) { let t, n, o;
...
const i = new c.BN(e.amount.toString()), a = g.computeSwap(n, o, i, this.clmmpoolData, this.swapTicks[n ? "aToB" : "bToA"]), s = g.TickMath.sqrtPriceX64ToPrice(this.clmmpoolData.currentSqrtPrice, this.reserveTokenDecimals[0], this.reserveTokenDecimals[1]).toNumber(), r = g.TickMath.sqrtPriceX64ToPrice(a.nextSqrtPrice, this.reserveTokenDecimals[0], this.reserveTokenDecimals[1]).toNumber();

let u = !1;

if (u = o ? a.amountIn.lt(i) : a.amountOut.lt(i), u) throw new Error("not enough liquidity");

return { notEnoughLiquidity: u, inAmount: _.default.BigInt(a.amountIn), outAmount: _.default.BigInt(a.amountOut), feeMint: t.toString(), feeAmount: _.default.multiply(_.default.BigInt(e.amount), _.default.BigInt(this.feeRate)), feePct: this.feeRate, priceImpactPct: Math.abs(s - r) / s } } getSwapLegAndAccounts(e) { let t, n;
...
const i = new c.BN(e.amount.toString()), a = g.computeSwap(t, n, i, this.clmmpoolData, this.swapTicks[t ? "aToB" : "bToA"], this.address, this.tickArrayMap);

return function ({ additionalArgs: e, userSourceTokenAccount: t, userDestinationTokenAccount: n, userTransferAuthority: o, sourceMint: i }) { const { aToB: a, accountA: s, accountB: r } = i.equals(e.tokenA) ? { aToB: !0, accountA: t, accountB: n } : { aToB: !1, accountA: n, accountB: t };

let c = [];

return e.remainingAccounts.forEach((e => { c.push({ pubkey: e, isSigner: !1, isWritable: !0 }) })), c.push(Ee), [Pe(de(a)), m.JUPITER_PROGRAM.instruction.cremaSwap({ accounts: { swapProgram: m.CREMA_PROGRAM_ID, clmmConfig: e.clmmConfig, clmmpool: e.clmmpool, tokenA: e.tokenA, tokenB: e.tokenB, accountA: s, accountB: r, tokenAVault: e.tokenAVault, tokenBVault: e.tokenBVault, tickArrayMap: e.tickArrayMap, owner: o, partner: m.CREMA_PARTNER_ACCOUNT, partnerAtaA: m.findAssociatedTokenAddress({ walletAddress: m.CREMA_PARTNER_ACCOUNT, tokenMintAddress: e.tokenA }), partnerAtaB: m.findAssociatedTokenAddress({ walletAddress: m.CREMA_PARTNER_ACCOUNT, tokenMintAddress: e.tokenB }), tokenProgram: u.TOKEN_PROGRAM_ID }, remainingAccounts: c }).keys] }({ additionalArgs: { clmmConfig: o, clmmpool: this.address, tokenA: this.clmmpoolData.tokenA, tokenB: this.clmmpoolData.tokenB, tokenAVault: this.clmmpoolData.tokenAVault, tokenBVault: this.clmmpoolData.tokenBVault, tickArrayMap: this.tickArrayMapPubkey, remainingAccounts: a.swapTickArrays }, ...e }) } get reserveTokenMints() { return [this.clmmpoolData.tokenA, this.clmmpoolData.tokenB] } } class ot { static async getStateFromStateAccount(e) { const t = await e.getAccountInfo(re);

if (!t) throw new Error("State account not found");

return (e => { const t = se.decode(e.data);

return { isInitialized: Boolean(t.isInitialized), stateOwner: t.stateOwner, feeOwner: t.feeOwner, initialSupply: t.initialSupply, returnFeeNumerator: t.returnFeeNumerator.toNumber(), fixedFeeNumerator: t.fixedFeeNumerator.toNumber(), feeDenominator: t.feeDenominator.toNumber(), curveType: t.curveType, curveParameters: t.curveParameters } })(t) } constructor(t, n, o) { this.id = void 0, this.label = "Cropper", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.poolState = void 0, this.tokenReserveAmounts = void 0, this.calculator = void 0, this.feePct = void 0, this.params = void 0, this.id = t.toBase58(), this.poolState = ue(t, n), this.params = { ...o, tokenAFeeAccount: new e.PublicKey(o.tokenAFeeAccount), tokenBFeeAccount: new e.PublicKey(o.tokenBFeeAccount) }, this.feePct = new C.default(this.params.fixedFeeNumerator).add(new C.default(this.params.returnFeeNumerator)).div(this.params.feeDenominator), this.calculator = new i.TokenSwapConstantProduct(new i.Fraction(_.default.BigInt(this.params.fixedFeeNumerator), _.default.BigInt(this.params.feeDenominator)), new i.Fraction(_.default.BigInt(this.params.returnFeeNumerator), _.default.BigInt(this.params.feeDenominator))) } getAccountsForUpdate() { return [this.poolState.tokenAAccount, this.poolState.tokenBAccount] } update(e) { const t = j(e, this.getAccountsForUpdate());

this.tokenReserveAmounts = Q(t) } getQuote({ sourceMint: e, amount: t }) { if (!this.tokenReserveAmounts) throw new Error(J);

const n = this.poolState.mintA.equals(e) ? 1 : 0, o = this.calculator.exchange(this.tokenReserveAmounts, t, n);

return { notEnoughLiquidity: !1, inAmount: t, outAmount: o.expectedOutputAmount, feeAmount: o.fees, feeMint: e.toBase58(), feePct: this.feePct.toNumber(), priceImpactPct: o.priceImpact.toNumber() } } getSwapLegAndAccounts(e) { const t = e.sourceMint.equals(this.poolState.mintA) ? this.params.tokenAFeeAccount : this.params.tokenBFeeAccount;

return function ({ poolState: e, feeAccount: t, sourceMint: n, userSourceTokenAccount: o, userDestinationTokenAccount: i, userTransferAuthority: a }) { const [s, r] = n.equals(e.mintA) ? [e.tokenAAccount, e.tokenBAccount] : [e.tokenBAccount, e.tokenAAccount];

return [Pe({ cropper: {} }), m.JUPITER_PROGRAM.instruction.cropperSwap({ accounts: { tokenSwapProgram: e.programId, tokenProgram: u.TOKEN_PROGRAM_ID, swap: e.ammId, swapState: re, authority: e.authority, userTransferAuthority: a, source: o, swapSource: s, swapDestination: r, destination: i, poolMint: e.poolMint, poolFee: t } }).keys] }({ poolState: this.poolState, feeAccount: t, ...e }) } get reserveTokenMints() { return [this.poolState.mintA, this.poolState.mintB] } } ot.decodePoolState = ue;

class it { constructor(e, t) { this.program = void 0, this.pool = void 0, this.bitmapCache = void 0, this.tickCache = void 0, this.accountsToFetch = { bitmaps: [], ticks: [] }, this.program = e, this.pool = t, this.bitmapCache = new Map, this.tickCache = new Map } async eagerLoadCache(e, t) { const n = _.default.toNumber(_.default.divide(_.default.BigInt(e), _.default.BigInt(t))), { wordPos: o } = A.tickPosition(n);

try { const e = [], { wordPos: n } = A.tickPosition(Math.floor(A.TickMath.MIN_TICK / t)), { wordPos: a } = A.tickPosition(Math.floor(A.TickMath.MAX_TICK / t)), s = Math.max(o - 10, n), r = Math.min(o + 10, a);

for (let t = s;

t < r;

t++)e.push(this.getBitmapAddressSync(t));

const u = await this.program.account.tickBitmapState.fetchMultiple(e), c = [];
...
const o = n + s, a = null === (i = u[n]) || void 0 === i ? void 0 : i.word, r = a ? A.generateBitmapWord(a) : new p.BN(0);

if (this.bitmapCache.set(o, { address: e[n], word: r }), r && !r.eqn(0)) for (let e = 0;

e < 256;

e++)if (r.shrn(e).and(new p.BN(1)).eqn(1)) { const n = this.getTickAddressSync(((o << 8) + e) * t);

c.push(n) } } const m = await this.program.account.tickState.fetchMultiple(c);

for (const e in c) { const t = m[e];

if (!t) continue;

const { tick: n, liquidityNet: o } = t;

this.tickCache.set(n, { address: c[e], liquidityNet: _.default.BigInt(o) }) } } catch (e) { } } lazyLoadAccountsToCache(e, t) { const n = _.default.toNumber(_.default.divide(_.default.BigInt(e), _.default.BigInt(t))), { wordPos: o } = A.tickPosition(n), i = [], a = [], { wordPos: s } = A.tickPosition(Math.floor(A.TickMath.MIN_TICK / t)), { wordPos: r } = A.tickPosition(Math.floor(A.TickMath.MAX_TICK / t)), u = Math.max(o - 10, s), c = Math.min(o + 10, r);

for (let e = u;

e < c;

e++) { i.push(this.getBitmapAddressSync(e));
...
const n = e + u, o = null !== (d = null === (l = a[e]) || void 0 === l ? void 0 : l.word) && void 0 !== d ? d : new p.BN(0);

if (this.bitmapCache.set(n, { address: i[e], word: o }), o && !o.eqn(0)) for (let e = 0;

e < 256;

e++)if (o.shrn(e).and(new p.BN(1)).eqn(1)) { const o = this.getTickAddressSync(((n << 8) + e) * t);

m.push(o) } } return this.accountsToFetch = { bitmaps: i, ticks: m }, [...i, ...m] } getTick(e) { let t = this.tickCache.get(e);

if (!t) throw new Error("Tick not cached");

return { address: t.address, liquidityNet: t.liquidityNet } } async getTickAddress(e) { return this.getTickAddressSync(e) } getTickAddressSync(t) { return e.PublicKey.findProgramAddressSync([A.TICK_SEED, this.pool.token0.toBuffer(), this.pool.token1.toBuffer(), A.u32ToSeed(this.pool.fee), A.u32ToSeed(t)], this.program.programId)[0] } async getBitmapAddress(e) { return this.getBitmapAddressSync(e) } getBitmapAddressSync(t) { return e.PublicKey.findProgramAddressSync([A.BITMAP_SEED, this.pool.token0.toBuffer(), this.pool.token1.toBuffer(), A.u32ToSeed(this.pool.fee), A.u16ToSeed(t)], this.program.programId)[0] } getBitmap(e) { let t = this.bitmapCache.get(e);

if (!t) throw new Error("Bitmap not cached");

return t } nextInitializedTickWithinOneWord(e, t, n) { let o = _.default.toNumber(_.default.divide(_.default.BigInt(e), _.default.BigInt(n)));

e < 0 && e % n != 0 && (o -= 1), t || (o += 1);

const { wordPos: i, bitPos: a } = A.tickPosition(o), s = this.getBitmap(i), { next: r, initialized: u } = A.nextInitializedBit(s.word, a, t);

return [A.buildTick(i, r, n), u, i, a, s.address] } updateCachedAccountInfos(e) { for (const t of this.accountsToFetch.bitmaps) { const n = e.get(t.toBase58());

if (n) { const e = this.program.coder.accounts.decode("tickBitmapState", n.data);

this.bitmapCache.set(e.wordPos, { address: t, word: A.generateBitmapWord(e.word) }) } } for (const t of this.accountsToFetch.ticks) { const n = e.get(t.toBase58());

if (n) { const e = this.program.coder.accounts.decode("tickState", n.data);

this.tickCache.set(e.tick, { address: t, liquidityNet: _.default.BigInt(e.liquidityNet) }) } } } } const at = _.default.BigInt(1e6), st = new p.Program(A.IDL, m.CYKURA_PROGRAM_ID, be);

class rt { constructor(t, n) { this.address = void 0, this.label = "Cykura", this.id = void 0, this.shouldPrefetch = !0, this.exactOutputSupported = !1, this.hasDynamicAccounts = !0, this.poolState = void 0, this.pool = void 0, this.tickDataProvider = void 0, this.tokens = void 0, this.vaults = void 0, this.feePct = void 0, this.fee = void 0, this.address = t, this.id = t.toBase58(), this.poolState = st.coder.accounts.decode("poolState", n.data);

const { token0: o, token1: i, fee: a, sqrtPriceX32: s, liquidity: r, tick: c } = this.poolState;

this.tickDataProvider = new it(st, { token0: o, token1: i, fee: a }), this.tokens = { token0: new f.Token(101, o, 0, "", ""), token1: new f.Token(101, i, 0, "", "") }, this.pool = new A.Pool(this.tokens.token0, this.tokens.token1, a, _.default.BigInt(s.toString()), _.default.BigInt(r.toString()), c, this.tickDataProvider), this.vaults = { vault0: e.PublicKey.findProgramAddressSync([this.address.toBuffer(), u.TOKEN_PROGRAM_ID.toBuffer(), o.toBuffer()], u.ASSOCIATED_TOKEN_PROGRAM_ID)[0], vault1: e.PublicKey.findProgramAddressSync([this.address.toBuffer(), u.TOKEN_PROGRAM_ID.toBuffer(), i.toBuffer()], u.ASSOCIATED_TOKEN_PROGRAM_ID)[0] }, this.fee = _.default.BigInt(this.poolState.fee), this.feePct = this.poolState.fee / _.default.toNumber(at) } getAccountsForUpdate() { return [this.address, ...this.tickDataProvider.lazyLoadAccountsToCache(this.pool.tickCurrent, this.pool.tickSpacing)] } update(e) { const t = e.get(this.address.toBase58());
...
this.pool = new A.Pool(this.tokens.token0, this.tokens.token1, n, _.default.BigInt(o.toString()), _.default.BigInt(i.toString()), a, this.tickDataProvider), this.tickDataProvider.updateCachedAccountInfos(e) } getQuote({ sourceMint: e, amount: t }) { const n = e.equals(this.poolState.token0) ? this.tokens.token0 : this.tokens.token1, [o, a, s] = this.pool.getOutputAmount(f.CurrencyAmount.fromRawAmount(n, t)), r = i.toDecimal(_.default.subtract(this.pool.sqrtRatioX32, a.sqrtRatioX32)).div(this.pool.sqrtRatioX32.toString());

return { notEnoughLiquidity: !1, inAmount: t, outAmount: o.quotient, feeAmount: _.default.divide(_.default.multiply(t, this.fee), at), feeMint: e.toBase58(), feePct: this.feePct, priceImpactPct: r.toNumber() } } getSwapLegAndAccounts(t) { const [n, o] = t.sourceMint.equals(this.poolState.token0) ? [this.vaults.vault0, this.vaults.vault1] : [this.vaults.vault1, this.vaults.vault0], i = e.PublicKey.findProgramAddressSync([A.OBSERVATION_SEED, this.poolState.token0.toBuffer(), this.poolState.token1.toBuffer(), A.u32ToSeed(this.poolState.fee), A.u16ToSeed(this.poolState.observationIndex)], m.CYKURA_PROGRAM_ID)[0], a = t.sourceMint.equals(this.poolState.token0) ? this.tokens.token0 : this.tokens.token1, [, , s] = this.pool.getOutputAmount(f.CurrencyAmount.fromRawAmount(a, t.amount)), r = e.PublicKey.findProgramAddressSync([A.OBSERVATION_SEED, this.poolState.token0.toBuffer(), this.poolState.token1.toBuffer(), A.u32ToSeed(this.poolState.fee), A.u16ToSeed((this.poolState.observationIndex + 1) % this.poolState.observationCardinalityNext)], m.CYKURA_PROGRAM_ID)[0], c = { poolAddress: this.address, inputVault: n, outputVault: o, nextObservationState: r, lastObservationState: i, swapAccountMetas: s };

return function ({ additionalArgs: e, userSourceTokenAccount: t, userDestinationTokenAccount: n, userTransferAuthority: o }) { return [Pe({ cykura: {} }), m.JUPITER_PROGRAM.instruction.cykuraSwap({ accounts: { swapProgram: m.CYKURA_PROGRAM_ID, signer: o, factoryState: m.CYKURA_FACTORY_STATE_ADDRESS, poolState: e.poolAddress, inputTokenAccount: t, outputTokenAccount: n, inputVault: e.inputVault, outputVault: e.outputVault, lastObservationState: e.lastObservationState, coreProgram: m.CYKURA_PROGRAM_ID, tokenProgram: u.TOKEN_PROGRAM_ID }, remainingAccounts: [...e.swapAccountMetas, { pubkey: e.nextObservationState, isSigner: !1, isWritable: !0 }, Ee] }).keys] }({ ...t, additionalArgs: c }) } get reserveTokenMints() { return [this.poolState.token0, this.poolState.token1] } } const ut = { DkwiQyA2JfD8ARfvMbMqu2DD4XKRkewRZVDE94SZNxSS: { price: 1 } }, ct = S.getDeltafiDexV2(m.DELTA_FI_PROGRAM_ID, be), mt = e => u.u64.fromBuffer(e.data.slice(64, 72)), dt = e => u.u64.fromBuffer(e.data.slice(36, 44));

function lt(e) { const t = e.readBigUInt64LE();

return Number(t) } function pt(e) { const t = e.readBigInt64LE(32);

return Number(t) } class ht { constructor(t, n) { this.address = void 0, this.id = void 0, this.label = "GooseFX", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !0, this.pairLayout = void 0, this.quoter = void 0, this.gooseFxAccounts = void 0, this.fixedAccounts = void 0, this.oracleAccounts = [], this.quoteParams = void 0, this.isQuoteInvalid = !0, this.slot = void 0, this.address = t, this.id = t.toBase58(), this.pairLayout = M.PAIR_LAYOUT.decode(n.data);

const [o, i] = this.pairLayout.mints, a = new M.SyncSwap;

this.quoter = a.getSyncQuoter(o, i), this.gooseFxAccounts = this.quoter.getAccounts();

const { pairAddress: s, sslIn: r, sslOut: u, liabilityVaultIn: c, liabilityVaultOut: m, swappedLiabilityVaultIn: d, swappedLiabilityVaultOut: l } = this.gooseFxAccounts;

this.fixedAccounts = [e.SYSVAR_CLOCK_PUBKEY, s, r, u, c, m, d, l], this.updateOracles() } updateOracles() { const e = Number(this.pairLayout.nOracle.toString()), t = this.pairLayout.oracles.slice(0, e).reduce(((e, t) => { const n = Number(t.n);

for (const o of t.elements.slice(0, n)) e.push(o.address);

return e }), []);

this.oracleAccounts = t } getAccountsForUpdate() { return [...this.fixedAccounts, ...this.oracleAccounts] } isSuspended(e) { if (this.quoteParams) { let t = Boolean(this.quoteParams.suspended);

if (void 0 !== e) for (const n of this.quoteParams.publishedSlots) t ||= n + this.quoteParams.maxDelay <= e;

return t } return !0 } update(e) { var t;
...
const s = this.pairLayout.feeRates[a ? 0 : 1], r = { notEnoughLiquidity: !1, inAmount: _.default.BigInt(i.amount_in.toString()), outAmount: _.default.BigInt(i.amount_out.toString()), feeAmount: _.default.BigInt(i.fee_paid.toString()), feeMint: e.toBase58(), feePct: s / 1e4, priceImpactPct: i.price_impact };

return i.free(), r } getSwapLegAndAccounts(e) { var t;

if (!this.quoteParams) throw new Error("Missing quote data");

const n = e.sourceMint.equals(this.pairLayout.mints[0]), { gooseFxAccounts: o } = this, [i, a, s, r, c, d] = n ? [o.sslIn, o.liabilityVaultIn, o.swappedLiabilityVaultIn, o.sslOut, o.liabilityVaultOut, o.swappedLiabilityVaultOut] : [o.sslOut, o.liabilityVaultOut, o.swappedLiabilityVaultOut, o.sslIn, o.liabilityVaultIn, o.swappedLiabilityVaultIn];

return function ({ additionalArgs: e, userSourceTokenAccount: t, userDestinationTokenAccount: n, userTransferAuthority: o }) { const i = [];

return i.push(e.referrer ? { pubkey: e.referrer, isSigner: !1, isWritable: !0 } : Ee), e.oracles.forEach((e => { i.push({ pubkey: e, isSigner: !1, isWritable: !1 }) })), i.push(Ee), [Pe({ gooseFx: {} }), m.JUPITER_PROGRAM.instruction.goosefxSwap({ accounts: { swapProgram: m.GOOSE_FX_PROGRAM_ID, controller: m.GOOSE_FX_CONTROLLER_ID, pair: e.pair, sslIn: e.sslIn, sslOut: e.sslOut, liabilityVaultIn: e.liabilityVaultIn, swappedLiabilityVaultIn: e.swappedLiabilityVaultIn, liabilityVaultOut: e.liabilityVaultOut, swappedLiabilityVaultOut: e.swappedLiabilityVaultOut, userInAta: t, userOutAta: n, feeCollectorAta: e.feeCollectorAta, userWallet: o, feeCollector: e.feeCollector, tokenProgram: u.TOKEN_PROGRAM_ID }, remainingAccounts: i }).keys] }({ additionalArgs: { pair: this.gooseFxAccounts.pairAddress, sslIn: i, sslOut: r, liabilityVaultIn: a, swappedLiabilityVaultIn: s, liabilityVaultOut: c, swappedLiabilityVaultOut: d, feeCollectorAta: m.findAssociatedTokenAddress({ walletAddress: this.pairLayout.feeCollector, tokenMintAddress: e.sourceMint }), feeCollector: this.pairLayout.feeCollector, oracles: this.oracleAccounts, referrer: null === (t = e.quoteMintToReferrer) || void 0 === t ? void 0 : t.get(e.sourceMint.toBase58()) }, ...e }) } get reserveTokenMints() { return this.pairLayout.mints } } const gt = new p.Program(w.IDL, m.INVARIANT_PROGRAM_ID, be);

class At { static parsePoolStructure(e) { return gt.coder.accounts.decode("pool", e.data) } static parseTickmap(e) { return gt.coder.accounts.decode("tickmap", e.data) } static parseTick(e) { return { ...gt.coder.accounts.decode("tick", e.data) } } static getQuote(e, t, n, o, i, a) { const { currentTickIndex: s, fee: r, tickSpacing: u, tokenX: m, liquidity: d, sqrtPrice: l } = e, p = { currentTickIndex: s, tickSpacing: u, liquidity: d, fee: r, sqrtPrice: l }, h = { xToY: o.equals(m), byAmountIn: a === exports.SwapMode.ExactIn, swapAmount: new c.BN(i.toString()), priceLimit: o.equals(m) ? w.calculatePriceSqrt(w.MIN_TICK) : w.calculatePriceSqrt(w.MAX_TICK), slippage: w.toDecimal(0), ticks: t, tickmap: n, pool: p };

return w.simulateSwap(h) } static getTickIndexToTickPubkeyHash(e, t, n) { if (!n) { const { tickAddress: n } = this.getTickAddress(e, t.currentTickIndex), o = new Map;

return o.set(t.currentTickIndex, n), o } const o = w.findClosestTicks(n.bitmap, t.currentTickIndex, t.tickSpacing, w.TICK_CROSSES_PER_IX, Infinity, "down"), i = w.findClosestTicks(n.bitmap, t.currentTickIndex, t.tickSpacing, w.TICK_CROSSES_PER_IX, Infinity, "up");

return o.concat([t.currentTickIndex]).concat(i).reduce(((t, n) => { const { tickAddress: o } = this.getTickAddress(e, n);

return t.set(n, o), t }), new Map) } static getTickAddress(t, n) { const o = Buffer.alloc(4);

o.writeInt32LE(n);

const [i, a] = e.PublicKey.findProgramAddressSync([Buffer.from(p.utils.bytes.utf8.encode("tickv1")), t.toBuffer(), o], gt.programId);

return { tickAddress: i, tickBump: a } } } class ft { constructor(e, t) { this.address = void 0, this.id = void 0, this.label = "Invariant", this.shouldPrefetch = !0, this.exactOutputSupported = !1, this.hasDynamicAccounts = !0, this.poolStructure = void 0, this.tickmap = void 0, this.tickPkToTickIndexHash = void 0, this.ticks = new Map, this.feePct = void 0, this.address = e, this.id = e.toBase58(), this.poolStructure = At.parsePoolStructure(t), this.tickPkToTickIndexHash = At.getTickIndexToTickPubkeyHash(this.address, this.poolStructure, this.tickmap), this.feePct = new C.default(this.poolStructure.fee.v.toString()).div(w.DENOMINATOR.toString()).toNumber() } getAccountsForUpdate() { const e = this.tickPkToTickIndexHash.values();

return [this.address, this.poolStructure.tickmap, ...e] } update(e) { const t = e.get(this.address.toBase58());
...
for (const [t, n] of this.tickPkToTickIndexHash) { const o = e.get(n.toBase58());

if (!o) continue;

const i = At.parseTick(o);

this.ticks.set(t, i) } } getQuote({ sourceMint: e, amount: t, swapMode: n }) { if (!this.tickmap) throw new Error("Missing tickmap");
...
return { notEnoughLiquidity: !1, inAmount: _.default.BigInt(a.toString()), outAmount: _.default.BigInt(o.accumulatedAmountOut.toString()), feeAmount: _.default.BigInt(o.accumulatedFee.toString()), feeMint: e.toBase58(), feePct: this.feePct, priceImpactPct: i } } getSwapLegAndAccounts(e) { var t;
...
return { notEnoughLiquidity: !1, inAmount: t, outAmount: _.default.BigInt(i.amountSwapped.toString()), feeAmount: _.default.BigInt(i.fee.ceil().toString()), feeMint: e.toBase58(), feePct: i.feePercent.toNumber(), priceImpactPct: i.priceImpact.toNumber() } } getSwapLegAndAccounts(e) { return function ({ swapState: e, sourceMint: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: i }) { const [a, s] = t.equals(e.tokenAMint) ? [e.poolCoinTokenAccount, e.poolPcTokenAccount] : [e.poolPcTokenAccount, e.poolCoinTokenAccount];

return [Pe({ lifinity: {} }), m.JUPITER_PROGRAM.instruction.lifinitySwap({ accounts: { swapProgram: e.programId, authority: e.authority, amm: e.amm, userTransferAuthority: i, sourceInfo: n, destinationInfo: o, swapSource: a, swapDestination: s, poolMint: e.poolMint, feeAccount: e.feeAccount, tokenProgram: u.TOKEN_PROGRAM_ID, pythAccount: e.pythAccount, pythPcAccount: e.pythPcAccount, configAccount: e.configAccount } }).keys] }({ swapState: this.swapState, ...e }) } get reserveTokenMints() { return [this.swapState.poolCoinMint, this.swapState.poolPcMint] } get isTradeFrozen() { var e;

return 1 === (null === (e = this.ammData) || void 0 === e ? void 0 : e.amm.freezeTrade) } } class kt { constructor(e, t) { this.address = void 0, this.id = void 0, this.label = "Lifinity V2", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.ammState = void 0, this.poolInfo = void 0, this.ammData = void 0, this.slot = void 0, this.address = e;

const n = new p.BorshAccountsCoder(T.IDL);

var o;

this.id = e.toBase58(), this.ammState = n.decode("amm", t.data), this.poolInfo = { amm: this.id, poolMint: (o = this.ammState).poolMint.toBase58(), feeAccount: o.feeAccount.toBase58(), oracleMainAccount: o.oracleMainAccount.toBase58(), oracleSubAccount: o.oracleSubAccount.toBase58(), oraclePcAccount: o.oraclePcAccount.toBase58(), poolCoinTokenAccount: o.tokenAAccount.toBase58(), poolCoinMint: o.tokenAMint.toBase58(), poolCoinDecimal: 0, poolPcTokenAccount: o.tokenBAccount.toBase58(), poolPcMint: o.tokenBMint.toBase58(), poolPcDecimal: 0, poolMintDecimal: 0, pythBaseDecimal: o.baseDecimals } } getAccountsForUpdate() { return [this.address, this.ammState.tokenAAccount, this.ammState.tokenBAccount, this.ammState.oracleMainAccount, this.ammState.oracleSubAccount, this.ammState.oraclePcAccount, e.SYSVAR_CLOCK_PUBKEY] } update(e) { const t = this.getAccountsForUpdate().reduce(((t, n) => { const o = e.get(n.toBase58());

return o && t.push({ publicKey: n, account: o }), t }), new Array);

this.ammData = T.getParsedData(t, this.poolInfo), this.slot = lt(t[t.length - 1].account.data) } getQuote({ sourceMint: e, amount: t }) { if (!this.ammData) throw new Error("Accounts not loaded, missing ammData");

if (void 0 === this.slot) throw new Error("Slot not fetched");

if (this.isTradeFrozen) throw new Error("Trade is frozen");

const n = this.ammState.tokenAMint.equals(e) ? T.TradeDirection.AtoB : T.TradeDirection.BtoA;
...
this.marinadeState = new Rt(this.marinadeStateResponse, new x.default(n.lamports), i.amount) } getQuote({ sourceMint: e, amount: t }) { if (!this.marinadeState) throw new Error("Update was not run to create a complete marinadeState");
...
class Ft { constructor(t, n, o) { this.address = void 0, this.params = void 0, this.id = void 0, this.label = "Mercurial", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.swapLayout = void 0, this.tokenMints = void 0, this.tokenReserveAmounts = void 0, this.calculator = void 0, this.address = t, this.params = o, this.id = t.toBase58(), this.swapLayout = Et(t, n), this.calculator = Ft.calculatorFromSwapState(this.swapLayout), this.tokenMints = o.tokenMints.map((t => new e.PublicKey(t))) } getAccountsForUpdate() { return [this.address, ...this.swapLayout.tokenAccounts] } static calculatorFromSwapState(e) { return new i.Stable(_.default.BigInt(e.tokenAccountsLength), _.default.BigInt(e.amplificationCoefficient), e.precisionMultipliers.map((e => _.default.BigInt(e))), new i.Fraction(_.default.BigInt(e.feeNumerator), _.default.BigInt(Ot))) } update(e) { const [t, ...n] = j(e, this.getAccountsForUpdate());

this.swapLayout = Ft.decodeSwapLayout(this.address, t), this.calculator = Ft.calculatorFromSwapState(this.swapLayout), this.tokenReserveAmounts = Q(n) } getQuote({ sourceMint: e, destinationMint: t, amount: n }) { if (!this.tokenReserveAmounts) throw new Error(J);

const o = this.tokenReserveAmounts.findIndex(((t, n) => this.tokenMints[n].equals(e))), i = this.tokenReserveAmounts.findIndex(((e, n) => this.tokenMints[n].equals(t))), a = this.calculator.exchange(this.tokenReserveAmounts, n, o, i), s = this.swapLayout.feeNumerator / Ot;

return { notEnoughLiquidity: !1, inAmount: n, outAmount: a.expectedOutputAmount, feeAmount: a.fees, feeMint: t.toBase58(), feePct: s, priceImpactPct: a.priceImpact.toNumber() } } getSwapLegAndAccounts(e) { return function ({ swapLayout: e, userSourceTokenAccount: t, userDestinationTokenAccount: n, userTransferAuthority: o }) { const i = [];

for (const t of e.tokenAccounts) i.push({ pubkey: t, isSigner: !1, isWritable: !0 });

return [Pe({ mercurial: {} }), m.JUPITER_PROGRAM.instruction.mercurialSwap({ accounts: Le(e, t, n, o), remainingAccounts: i }).keys] }({ swapLayout: this.swapLayout, ...e }) } get reserveTokenMints() { return this.params.tokenMints.map((t => new e.PublicKey(t))) } } Ft.decodeSwapLayout = Et;
...
class Ct { constructor(t, n, o) { var i, a;
...
else { if ("splStake" !== r) throw new Error("depegType not supported");

this.depegAccount = { pubkey: this.poolState.stake } } const { ownerTradeFeeDenominator: u, ownerTradeFeeNumerator: c, tradeFeeDenominator: m, tradeFeeNumerator: d } = this.poolState.fees;

this.feePct = new C.default(c.toString()).div(u.toString()).add(new C.default(d.toString()).div(m.toString())).toNumber() } getAccountsForUpdate() { var t;
...
return null !== (t = this.depegAccount) && void 0 !== t && t.pubkey && n.push(this.depegAccount.pubkey), n } update(e) { const [t, n, o, i, a, s, r, u, c, m, d] = j(e, this.getAccountsForUpdate());

d && this.depegAccount && this.depegAccounts.set(this.depegAccount.pubkey.toBase58(), d), this.data = { vaultA: xt(t), vaultB: xt(n), poolAVaultLpAmount: mt(o), poolBVaultLpAmount: mt(i), poolLpTotalSupply: dt(a), vaultALpTotalSupply: dt(s), vaultBLpTotalSupply: dt(r), vaultAReserve: mt(u), vaultBReserve: mt(c), currentTime: pt(m.data) } } getQuote({ sourceMint: e, destinationMint: t, amount: n }) { if (void 0 === this.data || this.depegAccount && 0 === this.depegAccounts.size) throw new Error("Missing initial fetch");
...
return { notEnoughLiquidity: !1, inAmount: n, outAmount: _.default.BigInt(i.amountOut.toString()), feeAmount: _.default.BigInt(i.fee.toString()), feeMint: t.toBase58(), feePct: this.feePct, priceImpactPct: i.priceImpact.toNumber() } } getSwapLegAndAccounts(e) { var t, n;
...
this.coinReserve = _.default.BigInt(s.add(c.baseTokenTotal).sub(new u.u64(String(m.needTakePnlCoin)))), this.pcReserve = _.default.BigInt(r.add(c.quoteTokenTotal).sub(new u.u64(String(m.needTakePnlPc)))) } getQuoteInternal({ amount: e, sourceMint: t, coinReserve: n, pcReserve: o, swapMode: i }) { const a = this.coinMint.equals(t) ? 1 : 0;

if (i == exports.SwapMode.ExactIn) { const t = this.calculator.exchange([n, o], e, a);

return { inAmount: e, outAmount: t.expectedOutputAmount, feeAmount: t.fees, priceImpactPct: t.priceImpact.toNumber() } } { const t = this.calculator.exchangeForExactOutput([n, o], e, a);

return { inAmount: t.expectedInputAmount, outAmount: e, feeAmount: t.fees, priceImpactPct: t.priceImpact.toNumber() } } } getQuote({ sourceMint: e, amount: t, swapMode: n }) { const { coinReserve: o, pcReserve: i } = this;
...
class Vt { constructor(e, t) { this.address = void 0, this.accountInfo = void 0, this.id = void 0, this.label = "Saber (Decimals)", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.wrappedToken = void 0, this.multiplierJsbi = void 0, this.address = e, this.accountInfo = t, this.id = e.toBase58(), this.wrappedToken = Ut.coder.accounts.decode("wrappedToken", t.data), this.multiplierJsbi = _.default.BigInt(this.wrappedToken.multiplier) } getAccountsForUpdate() { return new Array } update(e) { } toWrappedAmount(e) { return _.default.multiply(this.multiplierJsbi, e) } toUnderlyingAmount(e) { return _.default.divide(e, this.multiplierJsbi) } getAmounts(e, t) { if (t) return [e, this.toWrappedAmount(e)];

{ const t = this.toUnderlyingAmount(e);

return [this.toWrappedAmount(t), t] } } getQuote({ sourceMint: e, amount: t }) { const n = this.wrappedToken.wrappedUnderlyingMint.equals(e), [o, a] = this.getAmounts(t, n);

return { notEnoughLiquidity: !1, inAmount: o, outAmount: a, feeAmount: i.ZERO, feeMint: e.toBase58(), feePct: 0, priceImpactPct: 0 } } getSwapLegAndAccounts(e) { return function ({ wrapper: e, wrappedToken: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: i, deposit: a }) { return [Pe(a ? { saberAddDecimalsDeposit: {} } : { saberAddDecimalsWithdraw: {} }), m.JUPITER_PROGRAM.instruction.saberAddDecimals({ accounts: { addDecimalsProgram: m.SABER_ADD_DECIMALS_PROGRAM_ID, wrapper: e, wrapperMint: t.wrapperMint, wrapperUnderlyingTokens: t.wrappedUnderlyingTokens, owner: i, userUnderlyingTokens: a ? n : o, userWrappedTokens: a ? o : n, tokenProgram: u.TOKEN_PROGRAM_ID } }).keys] }({ wrapper: this.address, wrappedToken: this.wrappedToken, ...e, deposit: this.wrappedToken.wrappedUnderlyingMint.equals(e.sourceMint) }) } get reserveTokenMints() { return [this.wrappedToken.wrappedUnderlyingMint, this.wrappedToken.wrapperMint] } get wrapperMint() { return this.wrappedToken.wrapperMint } } class Gt { constructor(e) { this.stableSwap = void 0, this.id = void 0, this.label = "Saber", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.tokenReserveAmounts = void 0, this.stableSwapState = void 0, this.calculator = void 0, this.stableSwap = e, this.id = e.config.swapAccount.toBase58(), this.stableSwapState = e.state, this.calculator = new i.Stable(i.TWO, o.calculateAmpFactor(this.stableSwap.state), [i.ONE, i.ONE], new i.Fraction(this.stableSwap.state.fees.trade.numerator, this.stableSwap.state.fees.trade.denominator)) } getAccountsForUpdate() { return [this.stableSwap.config.swapAccount, e.SYSVAR_CLOCK_PUBKEY, this.stableSwap.state.tokenA.reserve, this.stableSwap.state.tokenB.reserve] } update(e) { const [t, n, ...a] = j(e, this.getAccountsForUpdate());

this.stableSwapState = o.decodeSwap(t.data);

const s = pt(n.data);

this.calculator.setAmp(o.calculateAmpFactor(this.stableSwapState, s)), this.calculator.setTraderFee(new i.Fraction(this.stableSwapState.fees.trade.numerator, this.stableSwapState.fees.trade.denominator)), this.tokenReserveAmounts = Q(a) } getQuote({ sourceMint: e, destinationMint: t, amount: n }) { if (this.stableSwap.state.isPaused) throw new Error("Saber pool is paused");
...
return { notEnoughLiquidity: !1, inAmount: n, outAmount: a.expectedOutputAmount, feeAmount: a.fees, feeMint: t.toBase58(), feePct: s.toNumber(), priceImpactPct: a.priceImpact.toNumber() } } getSwapLegAndAccounts(e) { return function ({ stableSwap: e, sourceMint: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: i }) { return [Pe({ saber: {} }), m.JUPITER_PROGRAM.instruction.saberSwap({ accounts: Ce(e, t, n, o, i) }).keys] }({ stableSwap: this.stableSwap, ...e }) } get reserveTokenMints() { return [this.stableSwap.state.tokenA.mint, this.stableSwap.state.tokenB.mint] } } const Yt = d.struct([d.blob(8, "discriminator"), H("factory"), d.u8("bump"), te("index"), H("admin"), H("token0Reserves"), H("token0Mint"), H("token0Fees"), H("token1Reserves"), H("token1Mint"), H("token1Fees"), d.u8("isPaused"), H("poolMint"), te("tradeFeeKbps"), te("withdrawFeeKbps"), te("adminTradeFeeKbps"), te("adminWithdrawFeeKbps")]);

class Wt { constructor(e, t) { this.id = void 0, this.label = "Sencha", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.poolState = void 0, this.calculator = void 0, this.tokenReserveAmounts = void 0, this.id = e.toBase58(), this.poolState = ((e, t) => { const n = t.owner, o = Yt.decode(t.data);

return { programId: n, isPaused: Boolean(o.isPaused), bump: o.bump, ammId: e, token0Reserves: o.token0Reserves, token1Reserves: o.token1Reserves, token0Mint: o.token0Mint, token1Mint: o.token1Mint, token0Fees: o.token0Fees, token1Fees: o.token1Fees, poolMint: o.poolMint, tradeFeeKbps: o.tradeFeeKbps.toNumber() } })(e, t), this.calculator = new i.TokenSwapConstantProduct(new i.Fraction(_.default.BigInt(this.poolState.tradeFeeKbps), _.default.BigInt(1e7)), new i.Fraction(i.ZERO, i.ZERO), !1) } get isPaused() { return this.poolState.isPaused } getAccountsForUpdate() { return [this.poolState.token0Reserves, this.poolState.token1Reserves] } update(e) { const t = j(e, this.getAccountsForUpdate());

this.tokenReserveAmounts = Q(t) } getQuote({ sourceMint: e, amount: t }) { if (this.isPaused) throw new Error("Sencha pool is paused");
...
for (let [e, n] of Jt(t)) { _.default.equal(s, i.ZERO) && (s = e), r = e;

const t = _.default.multiply(n, l), o = _.default.multiply(n, e);

if (c = _.default.add(c, t), _.default.greaterThanOrEqual(o, d)) { const t = _.default.divide(d, e);

u = _.default.add(u, _.default.multiply(e, t)), a = _.default.add(a, _.default.multiply(l, t)), d = i.ZERO;

break } u = _.default.add(u, _.default.multiply(e, n)), a = _.default.add(a, t), d = _.default.subtract(d, o) } let p = 0;

if (_.default.notEqual(s, i.ZERO)) { const e = new C.default(s.toString());

p = new C.default(r.toString()).sub(e).div(e).toNumber() } const h = $t(e, new x.default(s.toString())), g = $t(e, new x.default(u.toString())), A = g.mul(l.toString()).ceil(), f = g.mul(l.toString()).mul(o).ceil();

return { side: "buy", notEnoughLiquidity: _.default.lessThanOrEqual(c, a), minimum: { in: _.default.BigInt(h.mul(l.toString()).mul(1 + o).ceil()), out: l }, inAmount: _.default.BigInt(A.add(f)), outAmount: a, feeAmount: _.default.BigInt(f), priceImpactPct: p, feePct: o } }(e, t, o, u) : function (e, t, n, o) { let a = _.default.BigInt(0), s = _.default.BigInt(0), r = _.default.BigInt(0), u = _.default.BigInt(0), c = n, m = _.default.BigInt(0);
...
for (const [e, n] of Jt(t)) { _.default.equal(s, i.ZERO) && (s = e), r = e;

const t = _.default.multiply(d, n), o = _.default.multiply(n, _.default.multiply(e, l));

if (u = _.default.add(u, t), _.default.greaterThanOrEqual(t, c)) { const t = _.default.divide(c, d), n = _.default.multiply(t, e);

a = _.default.add(a, _.default.multiply(n, l)), c = _.default.subtract(c, n), m = _.default.add(m, _.default.multiply(t, d));

break } a = _.default.add(a, o), c = _.default.subtract(c, t), m = _.default.add(m, t) } let p = new C.default(a.toString()).mul(1 - o).floor(), h = 0;

const g = $t(e, new x.default(s.toString()));

if (_.default.notEqual(s, i.ZERO)) { const t = $t(e, new x.default(r.toString()));

h = g.minus(t).div(g).toNumber() } return { side: "sell", notEnoughLiquidity: _.default.greaterThan(_.default.BigInt(n), u), minimum: { in: d, out: _.default.BigInt(g.mul(_.default.toNumber(d)).mul(1 - o).floor().toString()) }, inAmount: m, outAmount: _.default.BigInt(p), feeAmount: _.default.BigInt(new C.default(a.toString()).mul(o).round()), priceImpactPct: h, feePct: o } }(e, n, o, u) }({ market: this.market, asks: this.orderbooks.asks, bids: this.orderbooks.bids, fromMint: e, toMint: t, fromAmount: n, isOpenbook: this.isOpenbook });

return { notEnoughLiquidity: o.notEnoughLiquidity, minInAmount: o.minimum.in, minOutAmount: o.minimum.out, inAmount: o.inAmount, outAmount: o.outAmount, feeAmount: o.feeAmount, feeMint: this.market.quoteMintAddress.toBase58(), feePct: o.feePct, priceImpactPct: o.priceImpactPct } } getSwapLegAndAccounts(e) { var t;

if (!e.openOrdersAddress) throw new Error("Missing open orders");

return function ({ market: e, sourceMint: t, openOrdersAddress: n, userSourceTokenAccount: o, userDestinationTokenAccount: i, userTransferAuthority: a, referrer: s, isOpenbook: r }) { const { side: u, coinWallet: c, pcWallet: d } = t.equals(e.baseMintAddress) ? { side: ce.Ask, coinWallet: o, pcWallet: i } : { side: ce.Bid, coinWallet: i, pcWallet: o };

return [Pe(r ? Se(u) : me(u)), m.JUPITER_PROGRAM.instruction.serumSwap({ accounts: xe(e, n, o, c, d, a), remainingAccounts: s ? [{ pubkey: s, isSigner: !1, isWritable: !0 }] : [Ee] }).keys] }({ market: this.market, openOrdersAddress: e.openOrdersAddress, referrer: null == e || null === (t = e.quoteMintToReferrer) || void 0 === t ? void 0 : t.get(this.market.quoteMintAddress.toBase58()), isOpenbook: this.isOpenbook, ...e }) } get reserveTokenMints() { return [this.market.baseMintAddress, this.market.quoteMintAddress] } } Zt.getL2 = Jt;
...
class nn { constructor(t, n, o) { if (this.label = void 0, this.id = void 0, this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.tokenSwapState = void 0, this.curveType = void 0, this.feePct = void 0, this.tokenReserveAmounts = void 0, this.calculator = void 0, this.label = o, this.id = t.toBase58(), this.tokenSwapState = function (t, n) { const o = n.owner, i = o.equals(m.STEP_TOKEN_SWAP_PROGRAM_ID) ? en.decode(n.data) : Ht.decode(n.data);
...
return [Pe(a ? { step: {} } : { tokenSwap: {} }), (a ? m.JUPITER_PROGRAM.instruction.stepSwap : m.JUPITER_PROGRAM.instruction.tokenSwap)({ accounts: { tokenSwapProgram: e.programId, tokenProgram: u.TOKEN_PROGRAM_ID, swap: e.address, authority: e.authority, userTransferAuthority: i, source: n, swapSource: s, swapDestination: r, destination: o, poolMint: e.poolToken, poolFee: e.feeAccount } }).keys] }({ tokenSwapState: this.tokenSwapState, ...e, isStep: this.tokenSwapState.programId.equals(m.STEP_TOKEN_SWAP_PROGRAM_ID) }) } get reserveTokenMints() { return [this.tokenSwapState.mintA, this.tokenSwapState.mintB] } } function on(e) { return e.reduce(((t, n) => (e.forEach((e => { n !== e && t.push([n, e]) })), t)), new Array) } const an = _.default.BigInt(100);

class sn { constructor(e, t, n) { this.firstAmm = void 0, this.secondAmm = void 0, this.reserveTokenMints = void 0, this.market = void 0, this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.portion1 = 0, this.portion2 = 0, this.firstAmm = e, this.secondAmm = t, this.reserveTokenMints = n, this.market = e instanceof Zt ? e.market : t instanceof Zt ? t.market : null } static getAmmIdsFromSplitTradeAmmId(e) { const t = e.split("-");

return t.length > 1 ? t : [] } static create(e, t) { if (!function (e, t) { return !Y(K, e.label, t.label) }(e, t)) return;

const n = on(e.reserveTokenMints), o = on(t.reserveTokenMints);

for (const i of n) for (const n of o) if (i.every(((e, t) => e.equals(n[t])))) return new sn(e, t, i) } setPortions(e, t) { if (e + t !== 100) throw new Error("Split trade portions must sum to 100");

this.portion1 = e, this.portion2 = t } get id() { return `${this.firstAmm.id}-${this.secondAmm.id}` } get label() { return [{ label: this.firstAmm.label, portion: this.portion1 }, { label: this.secondAmm.label, portion: this.portion2 }].sort(((e, t) => t.portion - e.portion)).map((({ label: e, portion: t }) => `${e} (${t}%)`)).join(" + ") } getAccountsForUpdate() { return [] } update(e) { } getQuote(e) { const t = e.sourceMint.toBase58(), n = e.amount;
...
t > 0) { const i = _.default.divide(_.default.multiply(n, _.default.BigInt(t)), an), a = _.default.subtract(n, i), s = this.firstAmm.getQuote({ ...e, amount: i }), r = this.secondAmm.getQuote({ ...e, amount: a }), u = _.default.add(s.outAmount, r.outAmount);

if (_.default.lessThan(u, o.outAmount)) break;

o = { outAmount: u, portion: t, firstQuote: s, secondQuote: r } } if (!o.firstQuote || !o.secondQuote) throw new Error("Unreachable: There was no better solution than getting 0 outAmount");
...
return { notEnoughLiquidity: !1, inAmount: e.amount, outAmount: a, feeAmount: _.default.add(d.amount, l.amount), feeMint: d.mint, feePct: p, priceImpactPct: h } } getSwapLegAndAccounts(e) { let [t, n] = this.firstAmm.getSwapLegAndAccounts(e), [o, i] = this.secondAmm.getSwapLegAndAccounts(e), a = [Te(this.portion1, t), Te(this.portion2, o)], s = [...n, ...i];

return [we(a), s] } } function rn(e, t) { const n = b.ParsableWhirlpool.parse(t);

if (!n) throw new Error(`Failed to parse whirlpool ${e.toBase58()}`);

return n } function un(e, t) { const n = b.ParsableTickArray.parse(t);

if (!n) throw new Error(`Failed to parse tick array ${e.toBase58()}`);

return n } class cn { constructor(t, n) { this.address = void 0, this.id = void 0, this.label = "Orca (Whirlpools)", this.shouldPrefetch = !0, this.exactOutputSupported = !0, this.hasDynamicAccounts = !0, this.whirlpoolData = void 0, this.tickArrays = { aToB: [], bToA: [] }, this.tickPks = void 0, this.oracle = void 0, this.feePct = void 0, this.address = t, this.id = t.toBase58(), this.whirlpoolData = rn(t, n.data), this.oracle = e.PublicKey.findProgramAddressSync([Buffer.from("oracle"), t.toBuffer()], m.WHIRLPOOL_PROGRAM_ID)[0], this.feePct = new C.default(this.whirlpoolData.feeRate).div(1e6), this.tickPks = this.getTickArrayPks() } getTickArrayPks() { const e = { aToB: [], bToA: [] };

return [!0, !1].forEach((t => { e[t ? "aToB" : "bToA"].push(...b.SwapUtils.getTickArrayPublicKeys(this.whirlpoolData.tickCurrentIndex, this.whirlpoolData.tickSpacing, t, m.WHIRLPOOL_PROGRAM_ID, this.address)) })), e } getAccountsForUpdate() { return [this.address, ...this.tickPks.aToB, ...this.tickPks.bToA] } update(e) { const t = e.get(this.address.toBase58());
...
for (const t of this.tickArrayPks) { const n = e.get(t.toBase58());

if (!n) continue;

const o = this.coder.decode("tickArrayState", n.data);

i[o.startTickIndex] = { ...o, address: t } } this.tickArrayCache = i, this.ammV3PoolInfo = B.Amm.formatPoolInfo({ address: this.address, poolState: this.poolState, ammConfig: o, programId: this.programId }) } getQuote(e) { if (0 !== this.poolState.status) throw new Error("Pool is not swapable");

if (!this.ammV3PoolInfo) throw new Error("Missing ammV3PoolInfo");

if (e.swapMode === exports.SwapMode.ExactIn) { const { amountOut: t, fee: n, priceImpact: o } = B.Amm.computeAmountOut({ poolInfo: this.ammV3PoolInfo, tickArrayCache: this.tickArrayCache, baseMint: e.sourceMint, amountIn: new x.default(e.amount.toString()), slippage: 0 });

return { notEnoughLiquidity: !1, inAmount: e.amount, outAmount: _.default.BigInt(t.toString()), feeAmount: _.default.BigInt(n.toString()), feeMint: e.sourceMint.toString(), feePct: this.ammV3PoolInfo.ammConfig.tradeFeeRate / 10 ** 6, priceImpactPct: o } } { const { amountIn: t, fee: n, priceImpact: o } = B.Amm.computeAmountIn({ poolInfo: this.ammV3PoolInfo, tickArrayCache: this.tickArrayCache, baseMint: e.destinationMint, amountOut: new x.default(e.amount.toString()), slippage: 0 });

return { notEnoughLiquidity: !1, inAmount: _.default.BigInt(t.toString()), outAmount: e.amount, feeAmount: _.default.BigInt(n.toString()), feeMint: e.sourceMint.toString(), feePct: this.ammV3PoolInfo.ammConfig.tradeFeeRate / 10 ** 6, priceImpactPct: o } } } getSwapLegAndAccounts(e) { if (!this.ammV3PoolInfo) throw new Error("Missing ammV3PoolInfo");
...
return function ({ additionalArgs: e, userSourceTokenAccount: t, userDestinationTokenAccount: n, userTransferAuthority: o }) { const i = e.remainingAccounts.map((e => ({ pubkey: e, isWritable: !0, isSigner: !1 })));
...
class hn { constructor(e, t) { this.address = void 0, this.id = void 0, this.label = void 0, this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.isBonkSwap = void 0, this.pool = void 0, this.calculator = void 0, this.feePct = void 0, this.tokenReserveAmounts = void 0, this.address = e, this.id = e.toBase58(), this.pool = this.decodePoolState(t), this.isBonkSwap = t.owner.equals(m.BONK_SWAP_PROGRAM_ID), this.label = this.isBonkSwap ? "BonkSwap" : "Oasis";

const n = this.pool.lpFee.v.add(this.pool.buybackFee.v).add(this.pool.mercantiFee.v).add(this.pool.projectFee.v);

this.feePct = new C.default(n.toString()).div(pn), this.calculator = new i.TokenSwapConstantProduct(new i.Fraction(_.default.BigInt(n), _.default.BigInt(pn)), i.ZERO_FRACTION, !1) } decodePoolState(e) { return ln.coder.accounts.decode("pool", e.data) } getAccountsForUpdate() { return [this.address] } update(e) { const t = e.get(this.id);

if (!t) throw new Error(`Pool account info is not found: ${this.id}`);

const n = this.decodePoolState(t);

this.pool = n, this.tokenReserveAmounts = [_.default.BigInt(n.tokenXReserve.v), _.default.BigInt(n.tokenYReserve.v)] } getQuote({ destinationMint: e, amount: t }) { const { tokenX: n } = this.pool;

if (!this.tokenReserveAmounts) throw new Error(J);

const o = e.equals(n) ? 0 : 1, i = this.calculator.exchange(this.tokenReserveAmounts, t, o);

return { notEnoughLiquidity: !1, inAmount: t, outAmount: i.expectedOutputAmount, feeAmount: i.fees, feeMint: e.toBase58(), feePct: this.feePct.toNumber(), priceImpactPct: i.priceImpact.toNumber() } } getSwapLegAndAccounts(t) { const n = m.JUPITER_FEE_OWNER;

return function ({ additionalArgs: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: i, sourceMint: a }) { const s = a.equals(t.tokenX), { swapperXAccount: r, swapperYAccount: c } = s ? { swapperXAccount: n, swapperYAccount: o } : { swapperXAccount: o, swapperYAccount: n };
...
class An { constructor(e, t) { this.address = void 0, this.id = void 0, this.label = "Phoenix", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.marketData = void 0, this.ladder = void 0, this.outAmountWithoutFeesMultiplier = void 0, this.baseLotsPerBaseUnit = void 0, this.baseLotSize = void 0, this.quoteLotSize = void 0, this.tickSizeInQuoteLotsPerBaseUnitPerTick = void 0, this.address = e, this.id = e.toBase58(), this.marketData = O.deserializeMarketData(t.data), this.outAmountWithoutFeesMultiplier = _.default.BigInt(1e4 - this.marketData.takerFeeBps), this.baseLotsPerBaseUnit = _.default.BigInt(this.marketData.baseLotsPerBaseUnit);

const n = this.marketData.header;

this.baseLotSize = _.default.BigInt(n.baseLotSize.toString()), this.quoteLotSize = _.default.BigInt(n.quoteLotSize.toString()), this.tickSizeInQuoteLotsPerBaseUnitPerTick = _.default.divide(_.default.BigInt(n.tickSizeInQuoteAtomsPerBaseUnit.toString()), this.quoteLotSize) } getAccountsForUpdate() { return [this.address, e.SYSVAR_CLOCK_PUBKEY] } update(e) { const [t, n] = j(e, this.getAccountsForUpdate());

if (!t) throw new Error(`Missing market accountInfo ${this.address.toBase58()}`);

const o = O.Market.load({ address: this.address, buffer: t.data, tokenList: [] });

this.marketData = o.data;

const i = lt(n.data), a = pt(n.data);

this.ladder = O.getMarketLadder(o, -1, i, a) } JSBImin(e, t) { return _.default.lessThan(e, t) ? e : t } computeQuote({ sourceMint: e, amount: t }) { if (!this.ladder) throw new Error(`Missing ladder for Phoenix: ${this.address.toBase58()}`);

let n, o = _.default.BigInt(0), a = i.ZERO, s = !1;

if (e.equals(this.marketData.header.baseParams.mintKey)) { let e = _.default.divide(t, this.baseLotSize);

const r = _.default.BigInt(e);

for (const { priceInTicks: t, sizeInBaseLots: a } of this.ladder.bids) { if (_.default.lessThanOrEqual(e, i.ZERO)) break;

const s = _.default.BigInt(t.toString()), r = _.default.BigInt(a.toString()), u = this.JSBImin(r, e), c = _.default.divide(_.default.multiply(_.default.multiply(_.default.multiply(s, u), this.tickSizeInQuoteLotsPerBaseUnitPerTick), this.quoteLotSize), this.baseLotsPerBaseUnit);

if (!n) { const e = _.default.multiply(u, this.baseLotSize);

n = new C.default(c.toString()).div(e.toString()) } o = _.default.add(o, c), e = _.default.subtract(e, u) } a = _.default.multiply(_.default.subtract(r, e), this.baseLotSize), _.default.greaterThan(e, i.ZERO) && (s = !0) } else { let e = _.default.divide(t, this.quoteLotSize);

const r = _.default.BigInt(e);

for (const { priceInTicks: t, sizeInBaseLots: a } of this.ladder.asks) { if (_.default.lessThanOrEqual(e, i.ZERO)) break;

const s = _.default.BigInt(t.toString()), r = _.default.BigInt(a.toString()), u = _.default.divide(_.default.divide(_.default.multiply(e, this.baseLotsPerBaseUnit), this.tickSizeInQuoteLotsPerBaseUnitPerTick), s);

let c, m;

_.default.greaterThan(r, u) ? (c = u, m = e) : (c = r, m = _.default.divide(_.default.multiply(_.default.multiply(s, c), this.tickSizeInQuoteLotsPerBaseUnitPerTick), this.baseLotsPerBaseUnit));

const d = _.default.multiply(c, this.baseLotSize);

if (!n) { const e = _.default.multiply(m, this.quoteLotSize);

n = new C.default(d.toString()).div(e.toString()) } o = _.default.add(o, d), e = _.default.subtract(e, m) } a = _.default.multiply(_.default.subtract(r, e), this.quoteLotSize), _.default.greaterThan(e, i.ZERO) && (s = !0) } const r = this.computAmountAfterFees(o), u = _.default.subtract(o, r), c = new C.default(o.toString()).div(t.toString());

if (!n) throw new Error("No best price");

return { notEnoughLiquidity: s, inAmount: a, outAmount: r, feeAmount: u, priceImpactPct: n.sub(c).div(n).toNumber() } } computAmountAfterFees(e) { return _.default.divide(_.default.multiply(e, this.outAmountWithoutFeesMultiplier), gn) } getQuote({ sourceMint: e, amount: t }) { const { notEnoughLiquidity: n, inAmount: o, outAmount: i, feeAmount: a, priceImpactPct: s } = this.computeQuote({ sourceMint: e, amount: t });

return { notEnoughLiquidity: n, inAmount: o, outAmount: i, feeAmount: a, feeMint: e.toBase58(), feePct: this.marketData.takerFeeBps / 1e4, priceImpactPct: s } } getSwapLegAndAccounts(t) { return function ({ additionalArgs: e, sourceMint: t, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: i }) { const { side: a, baseAccount: s, quoteAccount: r } = t.equals(e.baseMint) ? { side: ce.Ask, baseAccount: n, quoteAccount: o } : { side: ce.Bid, baseAccount: o, quoteAccount: n };

return [Pe(ke(a)), m.JUPITER_PROGRAM.instruction.phoenixSwap({ accounts: { swapProgram: m.PHOENIX_PROGRAM_ID, logAuthority: e.logAuthority, market: e.market, trader: i, baseAccount: s, quoteAccount: r, baseVault: e.baseVault, quoteVault: e.quoteVault, tokenProgram: u.TOKEN_PROGRAM_ID } }).keys] }({ ...t, additionalArgs: { logAuthority: e.PublicKey.findProgramAddressSync([Buffer.from("log")], m.PHOENIX_PROGRAM_ID)[0], market: this.address, baseVault: this.marketData.header.baseParams.vaultKey, quoteVault: this.marketData.header.quoteParams.vaultKey, baseMint: this.marketData.header.baseParams.mintKey } }) } get reserveTokenMints() { return [this.marketData.header.baseParams.mintKey, this.marketData.header.quoteParams.mintKey] } } function fn(e, t, n) { return Math.floor(e * t / n) } function Sn(e, t) { let n = e.coder.accounts.decode("tokenInfo", t), o = n.numTokens.toNumber(), i = [];
...
return i } class kn { constructor(e, t, n) { this.address = void 0, this.id = void 0, this.label = "Symmetry", this.shouldPrefetch = !0, this.exactOutputSupported = !1, this.hasDynamicAccounts = !0, this.fundState = void 0, this.tokenInfos = void 0, this.curveData = void 0, this.pythPrices = [], this.address = e, this.id = e.toBase58(), this.fundState = ve.coder.accounts.decode("fundState", t.data), this.tokenInfos = Sn(ve, Buffer.from(n.tokenInfoData, "base64"));

for (let e = 0;

e < this.tokenInfos.length;

e++)this.pythPrices.push({ aggregate: { price: 0 } }) } getAccountsForUpdate() { let t = [this.address, Re, Be];

for (let n = 0;

n < this.fundState.numOfTokens.toNumber();

n++)t.push(new e.PublicKey(this.tokenInfos[this.fundState.currentCompToken[n].toNumber()].pyth));

return t } update(e) { const [t, n, o] = j(e, this.getAccountsForUpdate());

this.tokenInfos = Sn(ve, n.data), this.curveData = ve.coder.accounts.decode("prismData", o.data);

let i = this.pythPrices;

for (let t = 0;

t < this.fundState.numOfTokens.toNumber();

t++) { const n = this.fundState.currentCompToken[t].toNumber(), o = this.tokenInfos[n].pyth, a = e.get(o);

if (!a) throw new Error(`Account info ${o} missing`);

let s = k.parsePriceData(a.data);

i[n] = s } this.fundState = ve.coder.accounts.decode("fundState", t.data), this.pythPrices = i } getQuote({ sourceMint: e, destinationMint: t, amount: n }) { if (!this.curveData) throw new Error("Can't calculate quote without curve data");

const o = function (e, t, n, o, i, a, s) { let r = s, u = 0, c = n.numOfTokens.toNumber(), m = e.findIndex((e => e.mint === i.toBase58())), d = e.findIndex((e => e.mint === a.toBase58())), l = -1, p = -1;

for (let t = 0;

t < c;

t++) { let i = n.currentCompToken[t].toNumber(), a = n.currentCompAmount[t].toNumber();

u += o[i].aggregate.price * (a / 10 ** e[i].decimals), i == m && (l = t), i == d && (p = t) } if (-1 == l || -1 == p || 0 == u) return;

let h = n.weightSum.toNumber(), g = 10 ** e[m].decimals, A = o[m].aggregate.price, f = .99999 * A - o[m].confidence / 2, S = 10 ** e[d].decimals, k = o[d].aggregate.price, y = 1.00001 * k + o[d].confidence / 2, M = s * f / g, w = n.targetWeight[l].toNumber() * u / n.weightSum.toNumber() * g / A, P = n.targetWeight[p].toNumber() * u / n.weightSum.toNumber() * S / k, T = M;

0 != m && (T = function (e, t, n, o, i, a) { let s = 0;

s = e > t ? t : e;

let r = 0, u = o, c = 10 ** a, m = n, d = m, l = 0;

for (let t = 0;

t < 10;

t++) { let n = Math.floor((9 * i.price[t].toNumber() + m) / 10);

if (n < d && (d = n), l += i.amount[t].toNumber(), l <= e - s) continue;

let o = Math.min(l - (e - s), i.amount[t].toNumber()), a = fn(o, d, c);

if (o > u) return fn(u, d, c) + r;

r += a, u -= o } return r += fn(u, d, c), r }(n.currentCompAmount[l].toNumber(), Math.floor(w), Math.floor(1e6 * f), s, t.sell[m], e[m].decimals) / 1e6);

let I = T * S / y;

0 != d && (I = function (e, t, n, o, i, a) { let s = 0;

s = e < t ? t : e;

let r = o, u = 0, c = 10 ** a, m = n, d = m, l = 0;
...
let o = Math.min(l - (s - e), i.amount[t].toNumber()), a = fn(o, d, c);

if (a > r) return fn(r, c, d) + u;

u += o, r -= a } return u += fn(r, c, d), u }(n.currentCompAmount[p].toNumber(), Math.floor(P), Math.floor(1e6 * y), Math.floor(1e6 * T), t.buy[d], e[d].decimals));

let b = M * S / y, v = 0;

b > n.currentCompAmount[p].toNumber() && (v = b - n.currentCompAmount[p].toNumber(), b = n.currentCompAmount[p].toNumber()), I > b && (I = b);

let R = b - I, B = R - Math.floor(5 * R / 100) - Math.floor(20 * R / 100) - Math.floor(20 * R / 100);

u = u + M - (b - B) * k / S;

let O = n.targetWeight[l].toNumber() / h, D = n.currentCompAmount[l].toNumber(), E = n.targetWeight[p].toNumber() / h, F = (n.currentCompAmount[p].toNumber() - (b - B)) / S, L = n.rebalanceThreshold.toNumber() / 1e4 * (n.lpOffsetThreshold.toNumber() / 1e4);

if (F * k / u < E * (1 - L) && E * (1 - L) > 0) return;

let _ = (D + s) / g, q = n.rebalanceThreshold.toNumber() / 1e4 * (n.lpOffsetThreshold.toNumber() / 1e4);

if (_ * A / u > O * (1 + q) && 0 != m && O * (1 + q) < 1) return;

let x = R + v, C = b - B + x;

return { inAmount: r, outAmount: Math.floor(I), feeMint: a, feeAmount: Math.ceil(x), priceImpact: x / C, feePct: x / C } }(this.tokenInfos, this.curveData, this.fundState, this.pythPrices, e, t, _.default.toNumber(n));

if (!o) throw new Error("Can't calculate quote");

return { notEnoughLiquidity: !1, inAmount: _.default.BigInt(o.inAmount), outAmount: _.default.BigInt(o.outAmount), feeAmount: _.default.BigInt(o.feeAmount), feeMint: o.feeMint.toBase58(), feePct: o.feePct, priceImpactPct: o.priceImpact } } getSwapLegAndAccounts(t) { return function ({ additionalArgs: t, sourceMint: n, destinationMint: o, userSourceTokenAccount: i, userDestinationTokenAccount: a, userTransferAuthority: s }) { let r = t.tokenInfos.findIndex((e => e.mint === n.toBase58())), c = t.tokenInfos.findIndex((e => e.mint === o.toBase58())), d = m.findAssociatedTokenAddress({ walletAddress: Oe, tokenMintAddress: o }), l = m.findAssociatedTokenAddress({ walletAddress: t.fundState.hostPubkey, tokenMintAddress: o }), p = m.findAssociatedTokenAddress({ walletAddress: t.fundState.manager, tokenMintAddress: o }), h = [];

for (let n = 0;

n < t.fundState.numOfTokens.toNumber();

n++) { let o = t.fundState.currentCompToken[n].toNumber();

h.push({ pubkey: new e.PublicKey(t.tokenInfos[o].pyth), isWritable: !1, isSigner: !1 }) } return [Pe(ye(new x.default(r), new x.default(c))), m.JUPITER_PROGRAM.instruction.symmetrySwap({ accounts: { swapProgram: m.SYMMETRY_PROGRAM_ID, buyer: s, fundState: t.fundAddress, pdaAccount: De, pdaFromTokenAccount: t.tokenInfos[r].pdaAccount, buyerFromTokenAccount: i, pdaToTokenAccount: t.tokenInfos[c].pdaAccount, buyerToTokenAccount: a, swapFeeAccount: d, hostFeeAccount: l, managerFeeAccount: p, tokenInfo: Re, prismData: Be, tokenProgram: u.TOKEN_PROGRAM_ID }, remainingAccounts: [...h, Ee] }).keys] }({ additionalArgs: { fundAddress: this.address, tokenInfos: this.tokenInfos, fundState: this.fundState }, ...t }) } get reserveTokenMints() { let t = [];

for (let n = 0;

n < this.fundState.numOfTokens.toNumber();

n++) { let o = this.tokenInfos[this.fundState.currentCompToken[n].toNumber()].mint;

t.push(new e.PublicKey(o)) } return t } } const yn = ({ amms: e, asLegacyTransaction: t, isSplit: n }) => { if (t) { if (e.length > 2) return !1;

const [t, o] = e;

return n ? !Y(U, t.label, o.label) : !Y(V, t.label, o.label) } return !0 }, Mn = new Map([[m.ORCA_V1_PROGRAM_ID.toString(), "Orca"], [m.ORCA_V2_PROGRAM_ID.toString(), "Orca"], [m.STEP_TOKEN_SWAP_PROGRAM_ID.toString(), "Step"], [m.PENGUIN_PROGRAM_ID.toString(), "Penguin"], [m.SAROS_PROGRAM_ID.toString(), "Saros"], [m.STEPN_PROGRAM_ID.toString(), "Stepn"]]);

function wn(t, i, a) { const s = new e.PublicKey(i.owner);

if (s.equals(m.MAINNET_SERUM_DEX_PROGRAM) || s.equals(m.DEVNET_SERUM_DEX_PROGRAM) || s.equals(m.OPENBOOK_PROGRAM_ID)) { const e = n.Market.getLayout(s).decode(i.data);

if (!e.accountFlags.initialized || !e.accountFlags.market) throw new Error("Invalid market");

const t = new n.Market(e, 0, 0, {}, s);

return new Zt(t) } if (s.equals(m.RAYDIUM_AMM_V4_PROGRAM_ID)) return new Kt(t, i, a);

if (s.equals(m.MERCURIAL_SWAP_PROGRAM_ID)) return new Ft(t, i, a);

if (s.equals(o.SWAP_PROGRAM_ID)) { const e = i.data.slice(2, 3), n = o.StableSwap.loadWithData(t, i.data, ie([t.toBuffer(), e], o.SWAP_PROGRAM_ID));

if (!n.state.isInitialized) return;

return new Gt(n) } if (s.equals(m.SABER_ADD_DECIMALS_PROGRAM_ID)) return new Vt(t, i);

if (s.equals(m.CREMA_PROGRAM_ID)) return new nt(t, i, a);

if (s.equals(m.ALDRIN_SWAP_PROGRAM_ID) || s.equals(m.ALDRIN_SWAP_V2_PROGRAM_ID)) return new je(t, i, a);

if ([...Mn.keys()].includes(s.toBase58())) { var r;

const e = null !== (r = Mn.get(i.owner.toBase58())) && void 0 !== r ? r : "Unknown";

return new nn(t, i, e) } return s.equals(m.CROPPER_PROGRAM_ID) ? new ot(t, i, a) : s.equals(m.SENCHA_PROGRAM_ID) ? new Wt(t, i) : s.equals(m.LIFINITY_PROGRAM_ID) ? new St(t, i) : s.equals(m.LIFINITY_V2_PROGRAM_ID) ? new kt(t, i) : s.equals(m.WHIRLPOOL_PROGRAM_ID) ? new cn(t, i) : s.equals(m.CYKURA_PROGRAM_ID) ? new rt(t, i) : s.equals(m.MARINADE_PROGRAM_ID) ? new vt(t, i) : s.equals(m.METEORA_PROGRAM_ID) ? new Ct(t, i, a) : s.equals(m.GOOSE_FX_PROGRAM_ID) ? new ht(t, i) : s.equals(m.INVARIANT_PROGRAM_ID) ? new ft(t, i) : s.equals(m.DRADEX_PROGRAM_ID) ? new mn(t, i, a) : s.equals(m.BALANSOL_PROGRAM_ID) ? new et(t, i) : s.equals(m.RAYDIUM_CLMM_PROGRAM_ID) ? new dn(t, i) : s.equals(m.MARCO_POLO_PROGRAM_ID) ? new hn(t, i) : s.equals(m.PHOENIX_PROGRAM_ID) ? new An(t, i) : s.equals(m.SYMMETRY_PROGRAM_ID) ? new kn(t, i, a) : void 0 } class Pn { constructor(e, t) { this.connection = void 0, this.ammIdToAddressLookupTable = void 0, this.ammIdToAddressLookupTableAccount = new Map, this.connection = e, this.ammIdToAddressLookupTable = t } async getAdressLookupTableAccounts(t) { const n = new Map, o = [...t.reduce(((e, t) => { const o = this.ammIdToAddressLookupTableAccount.get(t);

if (o) { const e = o.key.toBase58();

n.has(e) || n.set(e, t) } else { const o = this.ammIdToAddressLookupTable.get(t);

o && (e.add(o), n.set(t, o)) } return e }), new Set)];

return (await z(this.connection, o)).reduce(((t, i, a) => { const s = o[a];

if (i) { const o = new e.AddressLookupTableAccount({ key: new e.PublicKey(s), state: e.AddressLookupTableAccount.deserialize(i.data) });

t.push(o);

const a = n.get(s);

a && this.ammIdToAddressLookupTableAccount.set(a, o) } return t }), new Array) } } class Tn { constructor(e) { this.ammIdToAddressLookupTableAccount = void 0, this.ammIdToAddressLookupTableAccount = e } static async load(t, n) { const o = [...n.entries()], i = await z(t, o.map((([e, t]) => t))), a = new Map;

for (const [t, n] of i.entries()) { const [i, s] = o[t];

n && a.set(i, new e.AddressLookupTableAccount({ key: new e.PublicKey(s), state: e.AddressLookupTableAccount.deserialize(n.data) })) } return new Tn(a) } getAdressLookupTableAccounts(e) { const t = new Set, n = e.reduce(((e, n) => { const o = this.ammIdToAddressLookupTableAccount.get(n);

if (o) { const n = o.key.toBase58();

t.has(n) || (e.push(o), t.add(n)) } return e }), new Array);

return Promise.resolve(n) } } async function In(e, t, n) { const o = t.reduce(((e, t) => { var n;

const o = null == t || null === (n = t.params) || void 0 === n ? void 0 : n.addressLookupTableAddress;

return o && e.set(t.pubkey, o), e }), new Map);

return n ? await Tn.load(e, o) : new Pn(e, o) } const bn = {};

function vn(e) { const t = e._bn.toString(), n = bn[t];

if (n) return n;

{ const n = e.toBase58();

return bn[t] = n, n } } function Rn(e) { const t = new Map;

return e.forEach((e => { on(e.reserveTokenMints).forEach((([n, o]) => { !function (e, t, n, o) { let i = o.get(e);

i || (i = new Map([[t, []]]), o.set(e, i));

let a = i.get(t);

a || (a = [], i.set(t, a)), a.push(n) }(vn(n), vn(o), e, t) })) })), t } function Bn(e, t, n) { return Boolean(e && t > 100 && !e.has(n)) } async function On(t, n, o, i) { const a = m.getEmptyInstruction(), s = o.address.toString();

if (i) { let e = i.get(s);

if (e) { let n = null;

if (n = await t.getAccountInfo(e, "confirmed"), n) return { ...a, address: e } } } const [r, u] = function (t, n, o) { const [i] = e.PublicKey.findProgramAddressSync([Buffer.from("open_orders"), t.toBuffer(), o.toBuffer()], m.JUPITER_PROGRAM_ID);

return [i, m.JUPITER_PROGRAM.instruction.createOpenOrders({ accounts: { openOrders: i, payer: o, dexProgram: n, systemProgram: e.SystemProgram.programId, rent: e.SYSVAR_RENT_PUBKEY, market: t } })] }(o.address, o.programId, n);

return await t.getAccountInfo(r) || (a.setupInstructions = [u]), null == i || i.set(o.address.toString(), r), { ...a, address: r } } const Dn = { feeBps: 0, feeAccounts: new Map };

async function En(e, t) { return (await e.getTokenAccountsByOwner(t, { programId: u.TOKEN_PROGRAM_ID })).value.reduce(((e, t) => { const n = r.deserializeAccount(t.account.data);

return n && e.set(n.mint.toBase58(), t.pubkey), e }), new Map) } const Fn = function (e) { if (!Array.isArray(e)) throw new TypeError(`Argument must be an array: ${e}`) }, Ln = function (e, t) { return e * t.length }, _n = {}, qn = function (e, t) { return String(t) };

function xn(e) { return null != e } const Cn = _.default.BigInt(1e4);

function Nn({ inputMint: e, outputMint: t }) { return `${e}-${t}` } function Kn({ ammId: e, amount: t }) { return `${e}-${t.toString()}` } function Un(e, t, n) { return { ExactIn: _.default.greaterThanOrEqual(t.outAmount, e.outAmount) ? 1 : -1, ExactOut: _.default.lessThanOrEqual(t.inAmount, e.inAmount) ? 1 : -1 }[n] } async function Vn({ inputRouteSegment: t, inputMint: n, outputMint: o, amount: a, getDepositAndFeeForRoute: s, platformFeeBps: r, slippageBps: u, filterTopNResult: c = 1, onlyDirectRoutes: m, swapMode: d, asLegacyTransaction: l }) { const p = n.toBase58(), h = o.toBase58();

if (!t.get(p)) throw new Error("No routes found for the input and output mints");

const g = m || d === exports.SwapMode.ExactOut ? 1 : l ? 2 : 3, A = new Map, f = [], S = new Map;

return function a({ startMint: s, amount: r, level: u = 1, walked: p = [s] }) { const k = t.get(s);

k && k.forEach(((y, M) => { const w = Nn({ inputMint: s, outputMint: M }), P = function ({ amms: t, inputMint: n, outputMint: o, amount: i, swapMode: a }) { return t.map((t => { try { return { quote: t.getQuote({ amount: i, sourceMint: new e.PublicKey(n), destinationMint: new e.PublicKey(o), swapMode: a }), amm: t } } catch (e) { return } })).filter(xn).sort(((e, t) => Un(e.quote, t.quote, a))) }({ amms: y, inputMint: s, outputMint: M, amount: r, swapMode: d }), { filteredAmms: T, quoteMap: I } = P.reduce(((e, t) => (e.filteredAmms.length < c && e.filteredAmms.push(t.amm), e.quoteMap.set(Kn({ ammId: t.amm.id, amount: r }), t.quote), e)), { filteredAmms: [], quoteMap: new Map });

if (1 !== u || M !== h || m || d !== exports.SwapMode.ExactIn || function (e, t) { for (let n = 0;
...
o++)e[n].label !== e[o].label && t(e[n], e[o]) }(P.slice(0, Math.max(l ? 3 : 2, c)).map((({ amm: e }) => e)), ((e, t) => { const i = (() => { if (yn({ amms: [e, t], asLegacyTransaction: l, isSplit: !0 })) return sn.create(e, t) })();

i && f.push({ amms: [i], mints: [n, o] }) })), k.set(M, T), A.set(w, I), M !== h && I.size && !p.includes(M) && u < g) { var b;

const e = I.values().next().value.outAmount, t = null !== (b = S.get(M)) && void 0 !== b ? b : i.ZERO;

_.default.greaterThan(e, t) && (S.set(M, e), a({ startMint: M, amount: e, level: u + 1, walked: p.concat(M) })) } else if (M === h) { 1 === u && k.set(M, y);

const n = p.concat(M), o = n.map((t => new e.PublicKey(t))), i = n.reduce(((e, o, i) => { var a;

return i < n.length - 1 && e.push(null === (a = t.get(n[i])) || void 0 === a ? void 0 : a.get(n[i + 1])), e }), []), a = function (e) { if (function (e) { if (!Array.isArray(e)) throw new TypeError("Argument must be an array of arrays");

e.forEach(Fn), function ({ length: e }) { if (e >= 100) throw new TypeError(`Too many arrays (${e}): please use the 'big-cartesian' library instead of 'fast-cartesian'`) }(e), function (e) { const t = e.reduce(Ln, 1);

if (t >= 4294967296) { const e = Number.isFinite(t) ? ` (${t.toExponential(0)})` : "";

throw new TypeError(`Too many combinations${e}: please use the 'big-cartesian' library instead of 'fast-cartesian'`) } }(e) }(e), 0 === e.length) return [];

const t = [];

return function (e) { const t = _n[e];

if (void 0 !== t) return t;

const n = function (e) { const t = Array.from({ length: e }, qn), n = t.map((e => `for (const value${e} of arrays[${e}]) {`)).join("\n"), o = t.map((e => `value${e}`)).join(", "), i = "}\n".repeat(e);

return new Function("arrays", "result", `${n}\nresult.push([${o}])\n${i}`) }(e);

return _n[e] = n, n }(e.length)(e, t), t }(i);

for (let e of a) (1 === e.length || yn({ amms: e, asLegacyTransaction: l })) && f.push({ amms: e, mints: o }) } })) }({ startMint: p, amount: a }), f.map((e => { const { amms: t, mints: n } = e;

let o = [], c = a, m = i.ZERO;

const l = n, p = t.length;

for (const [e, n] of t.entries()) try { var h;

const t = l[e], s = l[e + 1], g = Nn({ inputMint: t.toBase58(), outputMint: s.toBase58() }), f = null === (h = A.get(g)) || void 0 === h ? void 0 : h.get(Kn({ ammId: n.id, amount: c }));

if (_.default.equal(c, i.ZERO)) return;

const S = f || n.getQuote({ sourceMint: t, destinationMint: s, amount: c, swapMode: d }), k = Gn({ quote: S, sourceMint: t, destinationMint: s, swapMode: d, legIndex: e, isLastLeg: p - 1 === e, platformFeeBps: r }), y = d === exports.SwapMode.ExactIn ? S.outAmount : S.inAmount;

let M = d === exports.SwapMode.ExactIn ? _.default.subtract(y, k.amount) : _.default.add(y, k.amount);

_.default.lessThan(M, i.ZERO) && (M = i.ZERO);

const w = _.default.BigInt(d === exports.SwapMode.ExactIn ? new C.default(M.toString()).mul(1 - u / _.default.toNumber(Cn)).ceil() : new C.default(M.toString()).mul(1 + u / _.default.toNumber(Cn)).floor()), [P, T] = d === exports.SwapMode.ExactIn ? [S.inAmount, M] : [M, c];

o.push({ amm: n, inputMint: t, outputMint: s, notEnoughLiquidity: S.notEnoughLiquidity, minInAmount: S.minInAmount, minOutAmount: S.minOutAmount, inAmount: P, outAmount: T, priceImpactPct: S.priceImpactPct, lpFee: { amount: S.feeAmount, mint: S.feeMint, pct: S.feePct }, platformFee: k }), c = d === exports.SwapMode.ExactIn ? M : a, m = w } catch (e) { return } return { marketInfos: o, getDepositAndFee: () => s({ marketInfos: o }), inAmount: o[0].inAmount, outAmount: c, amount: a, otherAmountThreshold: m, swapMode: d, slippageBps: u, priceImpactPct: 1 - o.reduce(((e, t) => e * (1 - t.priceImpactPct)), 1) } })).filter(xn).sort(((e, t) => Un(e, t, d))) } function Gn({ quote: e, sourceMint: t, destinationMint: n, swapMode: o, legIndex: a, isLastLeg: s, platformFeeBps: r }) { return s && o === exports.SwapMode.ExactIn ? { amount: _.default.divide(_.default.multiply(e.outAmount, _.default.BigInt(r)), Cn), mint: n.toBase58(), pct: r / 100 } : 0 === a && o === exports.SwapMode.ExactOut ? { amount: _.default.divide(_.default.multiply(e.inAmount, _.default.BigInt(r)), Cn), mint: t.toBase58(), pct: r / 100 } : { amount: i.ZERO, mint: n.toBase58(), pct: 0 } } class Yn { constructor(t, n, o, i, a, s, r = 0, u = !0, d, l, p) { this.connection = void 0, this.cluster = void 0, this.tokenRouteSegments = void 0, this.feeCalculator = void 0, this.platformFeeAndAccounts = void 0, this.quoteMintToReferrer = void 0, this.routeCacheDuration = void 0, this.wrapUnwrapSOL = void 0, this.intermediateTokens = void 0, this.shouldLoadSerumOpenOrders = void 0, this.addressLookupTableProvider = void 0, this.serumOpenOrdersPromise = void 0, this.user = void 0, this.routeCache = new Map, this.routeSegmentCache = new L.default({ max: 500 }), this.getDepositAndFees = async ({ marketInfos: e, userPublicKey: t, serumOpenOrdersPromise: n = Promise.resolve(new Map) }) => (async ({ connection: e, owner: t, inputMint: n, marketInfos: o, feeCalculator: i, serumOpenOrdersPromise: a, wrapUnwrapSOL: s }) => { const r = await Promise.all(o.map((async n => { const o = n.amm;

if (o instanceof Zt || o instanceof sn) { if (!o.market) return;

return await On(e, t.publicKey, o.market, await a) } }))), { userIntermediaryTokenAccountResults: u, userDestinationTokenAccountResult: c } = await m.getAtaInstructions({ connection: e, outputMints: o.map((e => e.outputMint)), owner: t, unwrapSOL: s }), d = !!s && [n, ...o.map((e => e.outputMint))].some((e => e.equals(m.WRAPPED_SOL_MINT)));

return m.calculateTransactionDepositAndFee({ intermediates: u, destination: c, openOrders: r, hasWrapUnwrapSOL: d, feeCalculator: i }) })({ connection: this.connection, feeCalculator: this.feeCalculator, inputMint: e[0].inputMint, marketInfos: e, serumOpenOrdersPromise: n, owner: new m.Owner(t), wrapUnwrapSOL: this.wrapUnwrapSOL }), this.getDepositAndFeesForUser = ({ marketInfos: e }) => { if (this.user && this.serumOpenOrdersPromise) { const t = new m.Owner(this.user);

return this.getDepositAndFees({ marketInfos: e, userPublicKey: t.publicKey, serumOpenOrdersPromise: this.serumOpenOrdersPromise }) } return Promise.resolve(void 0) }, this.exchange = async ({ routeInfo: t, userPublicKey: n, feeAccount: o, wrapUnwrapSOL: i, blockhashWithExpiryBlockHeight: a, asLegacyTransaction: s, computeUnitPriceMicroLamports: r }) => { var u;

const { connection: d, serumOpenOrdersPromise: l } = this, p = n || this.user;

if (!p) throw new Error("user not found");

const h = new m.Owner(p), g = t.marketInfos.length - 1, A = t.marketInfos[0].inputMint, f = t.marketInfos[g].outputMint, S = null != i ? i : this.wrapUnwrapSOL, [k, y, M] = await Promise.all([A.equals(m.WRAPPED_SOL_MINT) && S ? m.createAndCloseWSOLAccount({ connection: d, owner: h, amount: t.swapMode === exports.SwapMode.ExactIn ? t.amount : t.otherAmountThreshold }) : { ...m.getEmptyInstruction(), address: m.findAssociatedTokenAddress({ tokenMintAddress: A, walletAddress: h.publicKey }) }, m.getAtaInstructions({ connection: d, outputMints: t.marketInfos.map((e => e.outputMint)), owner: h, unwrapSOL: S }), Promise.all(t.marketInfos.map((async ({ amm: e }) => { if (e instanceof Zt || e instanceof sn) { if (!e.market) return;

return await On(d, h.publicKey, e.market, await l) } })))]), w = { intermediates: y.userIntermediaryTokenAccountResults, destination: y.userDestinationTokenAccountResult, openOrders: M }, P = w.openOrders.filter(Boolean).length > 0, T = (o = null !== (u = o) && void 0 !== u ? u : t.swapMode === exports.SwapMode.ExactIn ? this.platformFeeAndAccounts.feeAccounts.get(f.toBase58()) : this.platformFeeAndAccounts.feeAccounts.get(A.toBase58())) ? { feeBps: this.platformFeeAndAccounts.feeBps || Math.floor(100 * t.marketInfos[g].platformFee.pct), feeAccount: o } : void 0, { instruction: I } = await async function ({ user: t, openOrdersAddresses: n, userSourceTokenAccountAddress: o, userIntermediateTokenAccountAddresses: i, userDestinationTokenAccountAddress: a, routeInfo: s, platformFee: r, computeUnitPriceMicroLamports: u, quoteMintToReferrer: d }) { if (s.marketInfos.length - 1 !== i.length) throw new Error("Missing intermediary token account address");

const l = [o, ...i, a], p = !!r && r.feeBps > 0, h = t.publicKey, g = [e.ComputeBudgetProgram.setComputeUnitLimit({ units: 14e5 })];

u && u > 0 && g.push(e.ComputeBudgetProgram.setComputeUnitPrice({ microLamports: u }));

const A = [];

if (s.swapMode === exports.SwapMode.ExactIn) { const e = function (e, t, n, o, i, a, s, r) { const u = [], m = [];

for (const [t, o] of e.marketInfos.entries()) { const r = o.amm, [c, d] = i.slice(t), [l, p] = r.getSwapLegAndAccounts({ sourceMint: o.inputMint, destinationMint: o.outputMint, userSourceTokenAccount: c, userDestinationTokenAccount: d, userTransferAuthority: n, openOrdersAddress: a[t], quoteMintToReferrer: s, swapMode: e.swapMode, amount: o.inAmount });

u.push(l), m.push(...p) } return t && r && m.push({ pubkey: r.feeAccount, isWritable: !0, isSigner: !1 }), { swapInstruction: Fe(n, o, Me(u), m, new c.BN(e.amount.toString()), new c.BN(e.outAmount.toString()), e.slippageBps, t && r ? r.feeBps : 0) } }(s, p, h, a, l, n, d, r), { swapInstruction: t } = e;

A.push(t) } else if (s.swapMode === exports.SwapMode.ExactOut) { const { swapInstruction: e } = function (e, t, n, o, i, a) { const s = e.marketInfos[0], r = s.amm;

if (r.createExactOutSwapInstruction) return { swapInstruction: r.createExactOutSwapInstruction({ sourceMint: s.inputMint, destinationMint: s.outputMint, userSourceTokenAccount: n, userDestinationTokenAccount: o, userTransferAuthority: t, quoteMintToReferrer: i, swapMode: e.swapMode, amount: e.amount, slippageBps: e.slippageBps, inAmount: e.inAmount, platformFee: a, overflowFeeAccount: null == i ? void 0 : i.get(s.inputMint.toBase58()) }) };

throw new Error(`ExactOutInstruction missing for ${r.label}.`) }(s, h, o, a, d, r);

A.push(e) } const { signers: f, cleanupInstructions: S } = m.getEmptyInstruction();

return t.isKeyPair && t.signer && f.push(t.signer), { instruction: { setupInstructions: g, signers: f, cleanupInstructions: S, instructions: A } } }({ user: h, openOrdersAddresses: w.openOrders.map((e => null == e ? void 0 : e.address)), userSourceTokenAccountAddress: k.address, userIntermediateTokenAccountAddresses: w.intermediates.map((({ address: e }) => e)), userDestinationTokenAccountAddress: w.destination.address, routeInfo: t, platformFee: T, computeUnitPriceMicroLamports: r, quoteMintToReferrer: this.quoteMintToReferrer, asLegacyTransaction: s }), b = new m.TransactionBuilder(d, h.publicKey, h), v = [...w.intermediates, k, !w.destination.address.equals(k.address) && w.destination];

b.addInstruction(I), P && w.openOrders.forEach((e => { e && b.addInstruction(e) })), v.forEach((e => { e && b.addInstruction(e) })), a = a || await this.connection.getLatestBlockhash("confirmed");

const R = await this.addressLookupTableProvider.getAdressLookupTableAccounts(t.marketInfos.map((({ amm: e }) => e instanceof sn ? [e.firstAmm.id, e.secondAmm.id] : e.id)).flat()), { transaction: B } = await b.build(a, R, s), O = w;

return { swapTransaction: B, addressLookupTableAccounts: R, execute: ({ wallet: e, onTransaction: t } = {}) => m.executeTransaction({ connection: this.connection, wallet: e, onTransaction: t, inputMint: A, outputMint: f, sourceAddress: k.address, destinationAddress: O.destination.address, swapTransaction: B, owner: h, wrapUnwrapSOL: S }).finally((() => { this.routeCache.clear() })) } }, this.connection = t, this.cluster = n, this.tokenRouteSegments = o, this.feeCalculator = i, this.platformFeeAndAccounts = a, this.quoteMintToReferrer = s, this.routeCacheDuration = r, this.wrapUnwrapSOL = u, this.intermediateTokens = d, this.shouldLoadSerumOpenOrders = l, this.addressLookupTableProvider = p } static async load({ connection: t, cluster: n, user: o, platformFeeAndAccounts: i = Dn, quoteMintToReferrer: a, routeCacheDuration: s = 0, wrapUnwrapSOL: r = !0, marketsCache: u, restrictIntermediateTokens: c = !1, shouldLoadSerumOpenOrders: d = !1, ammsToExclude: l = { GooseFX: !0, Serum: !0 }, mintsToExclude: p = [], usePreloadedAddressLookupTableCache: h = !1 }) { const [{ tokenRouteSegments: g, addressLookupTableProvider: A, saberWrapperMints: f }, { value: { feeCalculator: S } }, k] = await Promise.all([Yn.loadCoreData({ connection: t, cluster: n, marketsCache: u, ammsToExclude: l, mintsToExclude: p, usePreloadedAddressLookupTableCache: h }), t.getRecentBlockhashAndContext("processed"), null != a ? a : En(t, new e.PublicKey(m.JUPITER_FEE_OWNER))]), y = !0 === c ? await Yn.getIntermediateTokens(f) : c ? c.intermediateTokens : void 0, M = new Yn(t, n, g, S, i, k, s, r, y ? new Set(y) : void 0, d, A);

return o && M.setUserPublicKey(o), M } static async loadCoreData({ connection: e, cluster: t, marketsCache: n, ammsToExclude: o, mintsToExclude: i, usePreloadedAddressLookupTableCache: a }) { let s;

s = !n || "url" in n ? await (async e => await (await N.default(e)).json())((null == n ? void 0 : n.url) || m.MARKETS_URL[t]) : n;

const { amms: r, saberWrapperMints: u, addressLookupTableProvider: c } = await Yn.fetchAmms(e, s, o, i, a);

return { tokenRouteSegments: Rn(r), addressLookupTableProvider: c, saberWrapperMints: u } } getAccountToAmmIdsMap() { const e = new Map;

return this.tokenRouteSegments.forEach((t => { Array.from(t.values()).forEach((t => { t.forEach((t => { t.getAccountsForUpdate().forEach((n => { const o = e.get(n.toBase58()) || new Set;

o.add(t.id), e.set(n.toBase58(), o) })) })) })) })), e } getAmmIdToAmmMap() { const e = new Map;

return this.tokenRouteSegments.forEach((t => { Array.from(t.values()).forEach((t => { t.forEach((t => { e.set(t.id, t) })) })) })), e } async computeRoutes({ inputMint: e, outputMint: t, amount: n, slippageBps: o, feeBps: i = 0, forceFetch: a, onlyDirectRoutes: s, swapMode: r = exports.SwapMode.ExactIn, filterTopNResult: u, asLegacyTransaction: c }) { const m = e.toBase58(), d = t.toBase58(), l = i || (this.platformFeeAndAccounts.feeAccounts.get(d) ? this.platformFeeAndAccounts.feeBps : 0), p = (new Date).getTime(), h = [m, d].sort(((e, t) => e.localeCompare(t))).join() + s + r + c, g = this.routeCache.get(h);

let A = this.routeSegmentCache.get(h);

A || (A = function ({ inputMint: e, outputMint: t, tokenRouteSegments: n, swapMode: o, intermediateTokens: i, onlyDirectRoutes: a, asLegacyTransaction: s }) { const r = new Map, u = n.get(e), c = n.get(t);

if (u && c) { const m = Math.min(u.size, c.size), d = new Map, l = new Map, [p, h, g, A] = [u, c, e, t];

for (let [e, t] of p.entries()) { if (t = o === exports.SwapMode.ExactIn ? t.slice() : t.filter((e => e.exactOutputSupported)), e === A) { const e = t;

d.set(A, e), l.set(g, e);

continue } if (a || o === exports.SwapMode.ExactOut || Bn(i, m, e)) continue;

let u = n.get(e) || new Map;

for (let [n, o] of u) { if (o = o.slice(), n === A) { const n = o, i = r.get(e) || new Map;

if (i.set(g, t), i.set(A, n), r.set(e, i), d.set(e, t), l.set(e, n), s) break } if (!s) { if (Bn(i, m, n)) continue;
...
u.set(A, a), r.set(n, u), l.set(n, a) } } } } r.set(g, d), r.set(A, l) } return r }({ inputMint: m, outputMint: d, tokenRouteSegments: this.tokenRouteSegments, intermediateTokens: this.intermediateTokens, onlyDirectRoutes: s, swapMode: r, asLegacyTransaction: c }), this.routeSegmentCache.set(h, A));
...
else if (g) { const { fetchTimestamp: e } = g;

p - e > this.routeCacheDuration && (f = !0) } else f = !0;

(a || f) && (await async function (e, t) { const n = new Map, o = new Set, i = new Map;

t.forEach((e => { e.forEach((e => { e.forEach((e => { i.set(e.id, e), e.getAccountsForUpdate().forEach((e => { o.add(e.toBase58()) })) })) })) }));

const a = Array.from(o);

a.length > 0 && ((await z(e, a)).forEach(((e, t) => { e && n.set(a[t], e) })), i.forEach((e => { e.update(n) }))) }(this.connection, A), this.routeCache.set(h, { fetchTimestamp: (new Date).getTime() }));

try { return { routesInfos: await Vn({ inputRouteSegment: A, inputMint: e, outputMint: t, amount: n, getDepositAndFeeForRoute: this.getDepositAndFeesForUser, onlyDirectRoutes: s, slippageBps: o, platformFeeBps: l, filterTopNResult: u, swapMode: r, asLegacyTransaction: c }), cached: !(a || f) } } catch (e) { throw e } finally { this.routeCache.forEach((({ fetchTimestamp: e }, t) => { e - p > this.routeCacheDuration && this.routeCache.delete(t) })) } } setUserPublicKey(e) { this.user = e;

const t = new m.Owner(this.user);

this.serumOpenOrdersPromise = this.shouldLoadSerumOpenOrders ? Yn.findSerumOpenOrdersForOwner({ connection: this.connection, cluster: this.cluster, userPublicKey: t.publicKey }) : Promise.resolve(new Map) } static async fetchAmms(t, n, o, i, a = !1) { return async function ({ connection: t, marketsCache: n, usePreloadedAddressLookupTableCache: o, ammsToExclude: i = {}, mintsToExclude: a = [] }) { const s = (t => t.map((t => { const { data: [n, o], pubkey: i, ...a } = t;

return { ...a, pubkey: new e.PublicKey(i), data: Buffer.from(n, o), owner: new e.PublicKey(a.owner) } })))(n);

{ const e = [];

if (e.length) { const n = await async function (e, t) { return await Promise.all((await z(e, t.map((e => e.toBase58())))).map((async (e, n) => { const o = t[n];

if (!e) throw new Error(`Failed to fetch pool ${o.toBase58()}`);

return { pubkey: o, ...e } }))) }(t, e);

s.push(...n) } } const r = [], u = [], c = s.map((e => e.pubkey.toBase58())), m = await z(t, c), d = new Set(a.map((e => e.toBase58()))), l = s.filter(((e, t) => m[t])).reduce(((e, t) => { try { const n = wn(t.pubkey, t, t.params);

if (n) { if (Y(i, n.label)) return e;

if (a && a.length && n.reserveTokenMints.some((e => d.has(e.toBase58())))) return e;

e.push(n), n.shouldPrefetch && r.push(n), n instanceof Vt && u.push(n.wrapperMint.toBase58()) } } catch (e) { } return e }), new Array), [p, h, g] = await Promise.all([$(r, t), M.loadWasm(), await In(t, n, o)]);

return { amms: l, saberWrapperMints: u, addressLookupTableProvider: g } }({ connection: t, marketsCache: n, ammsToExclude: o, mintsToExclude: i, usePreloadedAddressLookupTableCache: a }) } getRouteMap(e, t) { return function (e, t, n, o) { const i = new Map, a = new Set(e.keys());

a.forEach((e => { i.set(e, new Set) }));

for (const [A, f] of e) { const S = new Set(a);

for (let e of f.keys()) { var s, r;

null === (s = i.get(A)) || void 0 === s || s.add(e), null === (r = i.get(e)) || void 0 === r || r.add(A), S.delete(e) } if (!n) for (let a of S) { var u;

let s = null === (u = i.get(A)) || void 0 === u ? void 0 : u.has(a);

if (s) continue;

const r = e.get(A), f = e.get(a);

if (r && f) { const u = Math.min(r.size, f.size);

let [S, k, y, M] = [r, f, A, a];

for (let [r, f] of S.entries()) { if (n || Bn(t, u, r)) continue;

let S = e.get(r) || new Map;

for (let [e, n] of S) { if (e === M) { if (!o) { var c, m;

null === (c = i.get(A)) || void 0 === c || c.add(a), null === (m = i.get(a)) || void 0 === m || m.add(A), s = !0;

break } for (let e of f) { for (let t of n) if (yn({ amms: [e, t], asLegacyTransaction: o })) { var d, l;

null === (d = i.get(A)) || void 0 === d || d.add(a), null === (l = i.get(a)) || void 0 === l || l.add(A), s = !0;

break } if (s) break } } if (!o) { var p;

if (Bn(t, u, e)) continue;

if (null === (p = k.get(e)) || void 0 === p ? void 0 : p.slice()) { var h, g;

null === (h = i.get(A)) || void 0 === h || h.add(a), null === (g = i.get(a)) || void 0 === g || g.add(A), s = !0;

break } } } if (s) break } } } } return Array.from(i.entries()).reduce(((e, [t, n]) => (e.set(t, [...n]), e)), new Map) }(this.tokenRouteSegments, this.intermediateTokens, e, t) } static async getIntermediateTokens(e) { const t = await async function () { const e = await (await N.default("https://cache.jup.ag/top-tokens")).json();

return new Set(e.filter(((e, t) => t < 60))) }();

for (const e of Ie) t.add(e);

return e.forEach((e => t.add(e))), Array.from(t) } } Yn.getRemoteRouteMap = m.getRemoteRouteMap, Yn.findSerumOpenOrdersForOwner = async ({ userPublicKey: e, cluster: t, connection: o }) => { const i = new Map;

if (e) { const a = "mainnet-beta" === t ? m.MAINNET_SERUM_DEX_PROGRAM : m.DEVNET_SERUM_DEX_PROGRAM;

(await n.OpenOrders.findForOwner(o, e, a)).forEach((e => { i.set(e.market.toString(), e.address) })) } return i }, exports.AldrinAmm = je, exports.BalansolAmm = et, exports.CremaAmm = nt, exports.CropperAmm = ot, exports.CykuraAmm = rt, exports.DeltaFiAmm = class { constructor(t, n) { this.address = void 0, this.id = void 0, this.label = "DeltaFi", this.shouldPrefetch = !1, this.exactOutputSupported = !1, this.hasDynamicAccounts = !1, this.swapInfo = void 0, this.feePct = void 0, this.prices = void 0, this.pythAddresses = void 0, this.address = t, this.id = t.toBase58(), this.swapInfo = ct.coder.accounts.decode("SwapInfo", n.data);

const { swapConfig: o } = this.swapInfo;

this.feePct = o.tradeFeeNumerator / o.tradeFeeDenominator, this.pythAddresses = [this.swapInfo.pythPriceBase, this.swapInfo.pythPriceQuote].filter((t => !e.SystemProgram.programId.equals(t))) } getAccountsForUpdate() { return [this.address, ...this.pythAddresses] } getPriceData(e, t) { const { id: n } = this, o = e.get(t.toBase58()) || ut[n];

if (!o) throw new Error(`Missing pyth account info for ${t.toBase58()}`);

return "data" in o ? k.parsePriceData(o.data) : o } update(e) { const t = e.get(this.address.toBase58());

if (!t) throw new Error(`Missing ${this.address.toBase58()}`);

this.swapInfo = ct.coder.accounts.decode("SwapInfo", t.data);

try { const t = this.getPriceData(e, this.swapInfo.pythPriceBase), n = this.getPriceData(e, this.swapInfo.pythPriceQuote);

if (t.price && n.price) { const e = new y.BigNumber(t.price).dividedBy(new y.BigNumber(n.price)), o = new y.BigNumber(t.price + t.confidence).dividedBy(new y.BigNumber(n.price - n.confidence)), i = new y.BigNumber(t.price - t.confidence).dividedBy(new y.BigNumber(n.price + n.confidence));

this.prices = { marketPrice: e, highPrice: o, lowPrice: i } } else this.prices = void 0 } catch (e) { this.prices = void 0 } } getQuote({ destinationMint: e, amount: t }) { if (!this.prices) throw new Error("Missing price data from pyth");

const { swapInfo: n } = this, { amountIn: o, amountOut: i, priceImpact: a } = S.getSwappedAmountsAndPriceImpactFromRawValue(n, e.equals(n.mintQuote) ? { sellBase: {} } : { sellQuote: {} }, new y.BigNumber(t.toString()), this.prices.marketPrice, this.prices.highPrice, this.prices.lowPrice), s = i.multipliedBy(n.swapConfig.tradeFeeNumerator.toString()).dividedBy(n.swapConfig.tradeFeeDenominator.toString()).decimalPlaces(0), r = i.minus(s);

return { notEnoughLiquidity: !1, inAmount: _.default.BigInt(o), outAmount: _.default.BigInt(r), feeAmount: _.default.BigInt(s), feeMint: e.toBase58(), feePct: this.feePct, priceImpactPct: Number(a) } } getSwapLegAndAccounts(e) { var t;

if (!this.prices) throw new Error("Missing price data from pyth");

const { swapSourceToken: n, swapDestinationToken: o, adminDestinationToken: i } = this.swapInfo.mintBase.equals(e.sourceMint) ? { swapSourceToken: this.swapInfo.tokenBase, swapDestinationToken: this.swapInfo.tokenQuote, adminDestinationToken: this.swapInfo.adminFeeTokenQuote } : { swapSourceToken: this.swapInfo.tokenQuote, swapDestinationToken: this.swapInfo.tokenBase, adminDestinationToken: this.swapInfo.adminFeeTokenBase };

return function ({ additionalArgs: e, userSourceTokenAccount: t, userDestinationTokenAccount: n, userTransferAuthority: o }) { return [Pe((i = e.stable, { deltaFi: { stable: i } })), m.JUPITER_PROGRAM.instruction.deltafiSwap({ accounts: { swapProgram: m.DELTA_FI_PROGRAM_ID, marketConfig: e.marketConfig, swapInfo: e.swapInfo, userSourceToken: t, userDestinationToken: n, swapSourceToken: e.swapSourceToken, swapDestinationToken: e.swapDestinationToken, deltafiUser: m.DELTA_FI_USER_ID, adminDestinationToken: e.adminDestinationToken, pythPriceBase: e.pythPriceBase, pythPriceQuote: e.pythPriceQuote, userAuthority: o, tokenProgram: u.TOKEN_PROGRAM_ID }, remainingAccounts: e.referrer ? [{ pubkey: e.referrer, isSigner: !1, isWritable: !0 }] : [Ee] }).keys];

var i }({ additionalArgs: { stable: !!this.swapInfo.swapType.stableSwap, marketConfig: this.swapInfo.configKey, swapInfo: this.address, swapSourceToken: n, swapDestinationToken: o, adminDestinationToken: i, pythPriceBase: this.swapInfo.pythPriceBase, pythPriceQuote: this.swapInfo.pythPriceQuote, referrer: null === (t = e.quoteMintToReferrer) || void 0 === t ? void 0 : t.get(e.destinationMint.toBase58()) }, ...e }) } get reserveTokenMints() { return [this.swapInfo.mintQuote, this.swapInfo.mintBase] } }, exports.DradexAmm = mn, exports.FAKE_PROVIDER = be, exports.GooseFXAmm = ht, exports.IS_DEV = !0, exports.IS_PROD = !1, exports.IS_TEST = !1, exports.InvariantAmm = ft, exports.Jupiter = Yn, exports.LifinityAmm = St, exports.LifinityV2Amm = kt, exports.MIN_SEGMENT_SIZE_FOR_INTERMEDIATE_MINTS = 100, exports.MarcoPoloAmm = hn, exports.MarinadeAmm = vt, exports.MercurialAmm = Ft, exports.MeteoraAmm = Ct, exports.PhoenixAmm = An, exports.RaydiumAmm = Kt, exports.RaydiumClmm = dn, exports.SWAP_PROTOCOL_TOKENS = Ie, exports.SaberAddDecimalsAmm = Vt, exports.SaberAmm = Gt, exports.SenchaAmm = Wt, exports.SerumAmm = Zt, exports.SplTokenSwapAmm = nn, exports.SplitTradeAmm = sn, exports.SymmetryAmm = kn, exports.WhirlpoolAmm = cn, exports.ammFactory = wn, exports.getPlatformFeeAccounts = En, exports.getRouteInfoUniqueId = function (e) { return e.marketInfos.map((e => `${e.amm.id}-${e.inputMint}`)).join("-") }, Object.keys(m).forEach((function (e) { "default" === e || exports.hasOwnProperty(e) || Object.defineProperty(exports, e, { enumerable: !0, get: function () { return m[e] } }) }));
